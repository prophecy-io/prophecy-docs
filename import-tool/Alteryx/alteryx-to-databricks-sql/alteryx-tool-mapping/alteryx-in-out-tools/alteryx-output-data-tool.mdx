...
The [Alteryx Output Data tool](https://help.alteryx.com/current/en/designer/tools/in-out-tools/output-data-tool.html) and the [Prophecy Target gem](https://docs.prophecy.io/analysts/source-target) both write data from a workflow or pipeline to an external destination.
