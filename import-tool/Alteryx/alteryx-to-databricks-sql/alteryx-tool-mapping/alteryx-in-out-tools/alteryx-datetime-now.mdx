...
In Prophecy, you can replicate this functionality by using the [Reformat gem](https://docs.prophecy.io/analysts/reformat/) to add a new column with a SQL expression such as `current_timestamp()` or `current_date()`. (The Reformat gem lets you add or modify columns using SQL expressions.)
