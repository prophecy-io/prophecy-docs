...
Prophecy provides equivalent functionality through its [Multi-Column Edit gem](https://docs.prophecy.ai/data-analysis/gems/prepare/multi-column-edit/). This gem lets you define one transformation pattern that is applied to all selected columns.
