...
Prophecy accomplishes this behavior using a combination of [WindowFunction gems](/data-analysis/gems/transform/window) and [Reformat gems](/data-analysis/gems/prepare/reformat#parameters), which provide an equivalent set of capabilities through SQL analytic expressions.
...
6. Preview results in the [Data Explorer](/data-analysis/development/runs/data-explorer/data-profile) to confirm row alignment and behavior. (You can also preview results using the **Data** button in gems.)
...
6. Confirm results using the [Data Explorer](/data-analysis/development/runs/data-explorer/data-profile).
...
4. Confirm results using the [Data Explorer](/data-analysis/development/runs/data-explorer/data-profile).
