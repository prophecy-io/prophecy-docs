---
title: Migrate to Databricks SQL
...
1. In the **Bundle Details** tab, fill out the following fields:
   ...
   | SQL Fabric         | Choose the [fabric](/data-analysis/environment/fabrics/prophecy-fabrics) the Transpiler will use to run Prophecy pipelines.                       |
