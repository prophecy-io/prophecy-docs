---
title: Alteryx | Migrate to SQL
description: How to migrate from Alteryx to SQL
---
...
- Prophecy cannot migrate Alteryx schedules. You must [manually configure your schedule](https://docs.prophecy.io/analysts/scheduling) in your Prophecy project after you transpile your Alteryx workflow. Then, you can monitor your schedule on [the Monitoring page](https://docs.prophecy.io/analysts/monitoring/#scheduled-pipelines).
...
Start with creating a new bundle in the Transpiler.

1. On the left navigation bar, click the **Transpiler icon** (arrow pointing down in a circle).
...
1. In the **Bundle Details** tab, fill out the following fields:
   ...
   | SQL Fabric         | Choose the [fabric](https://docs.prophecy.io/administration/fabrics/prophecy-fabrics/) the Transpiler will use to run Prophecy pipelines.                       |
...
### Step 2: Configure the transpilation
...
<Note>
Once you add a pipeline or table to the bundle, you can disable the import by deselecting the relevant checkbox. Disabling the import is useful if you want to save the pipeline or table in the import configuration to import it at a later time.
</Note>

### Step 3: Import transpiled entities
...
### Step 4: Review Prophecy project
