...
At the moment, Transpiler supports transpiling [a subset of Alteryx tools](/import-tool/Alteryx/alteryx-to-databricks-sql/alteryx-tool-mapping/alteryx-tool-mapping). If you import an unsupported tool, use the [solution](#solution) provided as a workaround to this limitation.
