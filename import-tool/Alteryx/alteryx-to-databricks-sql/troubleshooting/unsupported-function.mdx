...
At the moment, Transpiler supports transpiling [a subset of Alteryx functions](/import-tool/Alteryx/alteryx-to-databricks-sql/databricks-functions-mappings.mdx). If you import an unsupported function, use the [solution](#solution) provided as a workaround to this limitation.
...
1. Update the function.
   ...
   - Build your own expression with the [Visual Expression Builder](https://docs.prophecy.io/analysts/visual-expression-builder).
