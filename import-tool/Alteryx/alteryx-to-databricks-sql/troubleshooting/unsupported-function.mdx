...
At the moment, Transpiler supports transpiling [a subset of Alteryx functions](/import-tool/Alteryx/alteryx-to-databricks-sql/databricks-functions-mappings). If you import an unsupported function, use the [solution](#solution) provided as a workaround to this limitation.
