---
title: Informatica migration overview
description: A tutorial on using Informatica Transpiler
---
...
- ** XML files ** : XML files contain information about the workflow like components used in the workflow and connection between them. It also holds any parameters, macros, or other metadata associated with the workflow. Example:
  ...
  ![XML File](/import-tool/informatica/img/informatica_file.png)
...
![Source page](/import-tool/informatica/img/informatica_source_page.png)
...
![Upload artifacts](/import-tool/informatica/img/upload_informatica_artifact.png)

Upload the Informatica files that you want to transpile and click on the Next button.

![Entity page](/import-tool/informatica/img/informatica_entity_page.png)
...
![Add pipeline](/import-tool/informatica/img/informatica_add_pipeline.png)

Provide a (1) readable name to the pipeline.

## 3. Validate and Transpile

![Validate section](/import-tool/informatica/img/informatica_validate.png)
...
![Validate warning](/import-tool/informatica/img/informatica_validate_warning.png)
...
![Transpiler progress](/import-tool/informatica/img/informatica_progress.png)
...
![Resolve conflicts](/import-tool/informatica/img/informatica_resolve_conflicts.png)
...
![Package overview](/import-tool/informatica/img/informatica_package_overview.png)
...
![Pipeline](/import-tool/informatica/img/informatica_open_pipeline.png)
...
![Pipeline canvas](/import-tool/informatica/img/informatica_pipeline_canvas.png)
...
![Pipeline code](/import-tool/informatica/img/informatica_pipeline_code.png)

Prophecy has also generated optimal high-performance open source Spark code for you.

## 5. Run Pipeline

![Pipeline fabric](/import-tool/informatica/img/informatica_pipeline_fabric.png)
...
![Source filepath](/import-tool/informatica/img/informatica_source_path.png)
...
![Run pipeline](/import-tool/informatica/img/informatica_run_pipeline.png)

Now run the pipeline by clicking on the **Run** button.

![Interim data](/import-tool/informatica/img/informatica_interim_data.png)
