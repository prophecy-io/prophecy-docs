---
title: Informatica Intelligent Cloud Services | Migrate to Spark
...
1. Select or create the **Spark Fabric** that you will use with the bundle. (SQL fabrics are not supported.) See [Spark fabrics](https://docs.prophecy.io/administration/fabrics/Spark-fabrics/Fabrics/) for more information.
...
You’ll see Informatica transformations represented as **Prophecy gems**. Unsupported or partially translated components will appear as [ToDo gems](https://docs.prophecy.io/analysts/development/gems/custom/todo), placeholders that mark where manual adjustments are required.
...
1. If necessary, update [Source/Target gems](https://docs.prophecy.io/engineers/source-target) to connect to your datasets.
