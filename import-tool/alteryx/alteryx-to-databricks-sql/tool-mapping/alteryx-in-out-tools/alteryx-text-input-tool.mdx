...
The [Alteryx Text Input tool](https://help.alteryx.com/current/en/designer/tools/in-out-tools/text-input-tool.html) and a [Prophecy Table Gem configured as a Seed](/data-analysis/gems/source-target/table/prophecy-warehouse#seeds) both allow you to bring small, manually-defined datasets into a workflow.
