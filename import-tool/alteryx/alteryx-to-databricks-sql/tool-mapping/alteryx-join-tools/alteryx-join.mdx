...
- Select a join type:
  ...
  - Cross join
  - Natural inner join/natural left outer join/natural right outer join/natural full outer join
- Define the join condition by selecting columns from each input and a comparison operator (for example, `equals`).
