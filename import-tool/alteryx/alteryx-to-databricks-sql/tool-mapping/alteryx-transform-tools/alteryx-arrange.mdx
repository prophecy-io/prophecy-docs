...
Prophecy implements this exact functionality using multiple [Reformat gems](/data-analysis/gems/prepare/reformat), but for many operations, we recommend using the [Unpivot gem](/data-analysis/gems/transform/unpivot), especially if adding manual desriptions is not required behavior.
