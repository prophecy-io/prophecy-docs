...
- The selected aggregation method (for example, Sum, Count, Min, Max) is mapped to the Pivot gem’s aggregation function.
...
5. Choose the appropriate aggregation function.

This produces a wide, pivoted dataset suitable for reporting or downstream analysis.
