...
description: Mapping between Alteryx’s Weighted Average tool and equivalent implementations in Prophecy (Databricks SQL)
---
...
3. Use a guarded weighted-average expression:
...
3. Add a computed output column (for example, `WeightedAverage`) using the same expression:
...
### Alteryx Weighted Average example
...
### Prophecy equivalent (Reformat or Aggregate)
