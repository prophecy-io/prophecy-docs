...
![Example input and output](/import-tool/abinitio/abinitio-gems/img/normalize-input-output.png)
...
![Normalize output columns](/import-tool/abinitio/abinitio-gems/img/normalize-output-columns.png)
