...
## Break large Alteryx workflows into multiple pipelines

When importing Alteryx workflows into SQL projects, you can now enable **Break into Multiple Workflows** to split large workflows into smaller Prophecy pipelines.

Prophecy automatically creates an orchestration pipeline to coordinate execution of the generated pipelines. During splitting, Prophecy can also preserve Alteryx visual containers so that related workflow sections remain grouped together in the generated pipelines.
