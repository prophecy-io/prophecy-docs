...
The Reformat gem now provides faster interactive feedback when building transformations.
...
The Agent now supports more interactive workflows directly within chat, giving you greater control over how tasks are executed.
...
You can now calculate data profile statistics across an entire dataset, not just the initial sample of 10,000 rows.
