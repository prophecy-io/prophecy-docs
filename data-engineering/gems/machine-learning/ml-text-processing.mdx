...
![Overview web scrape and extract text](/data-engineering/gems/machine-learning/img/ml-text-proc-scrape-extract-overview.png)

#### 1a. Configure web scrape

![Configure to web scrape](/data-engineering/gems/machine-learning/img/ml-text-proc-scrape-configure.png)
...
![Overview Chunkify](/data-engineering/gems/machine-learning/img/ml-text-proc-overview-chunkify.png)
...
![Configure to Chunkify](/data-engineering/gems/machine-learning/img/ml-text-proc-configure-chunkify.png)
