...
1. [Load](/data-engineering/text-processing/#1-load-web-urls-and-extract-text) web URLs and extract text.
2. [Split](/data-engineering/text-processing/#2-split-text-data-into-equal-chunks) text data into equal chunks.

Follow along to see how to use the TextProcessing gem. For an example set of pipelines that uses this gem to create a Generative AI Chatbot, see this [guide](/data-engineering/generative-ai-chatbot).
