---
title: Gems for Data Engineering
...
| **Custom**            | The set of gems that our creative teams build using Expression Builder to extend the Prophecy capabilities. |
...
![Gem Instance](/data-engineering/gems/img/gems/instance.png)
...
![Gem instance configuration](/data-engineering/gems/img/gems/instance_open.png)
...
![Input UI](/data-engineering/gems/img/gems/inputs.png)
...
| **Data Preview**  | [Selective](/data-engineering/development/runs/data-sampling) data sampling only: Use this checkbox to enable/disable the generation of the data sample for the gem.                                                                            |
| **Record Count**  | [Selective](/data-engineering/development/runs/data-sampling) data sampling only: Use this checkbox to enable/disable display of the total record count for a gem's output. The record count appears above the interim after the pipeline runs. |
...
![Gem action menu](/data-engineering/gems/img/gem-action-menu.png)
