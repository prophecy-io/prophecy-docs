...
| **Data Preview**  | For [selective data sampling](/data-engineering/development/runs/data-sampling), use this checkbox to enable/disable the generation of the data sample for the gem.                                                                                     |
| **Record Count**  | When [selective data sampling](/data-engineering/development/runs/data-sampling), use this checkbox to enable/disable display of the total record count for the output dataset. The record count appears above the data sample after the pipeline runs. |
