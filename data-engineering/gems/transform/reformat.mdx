---
title: Reformat gem for Data Engineering
...
![Example usage of Reformat](/data-engineering/gems/transform/img/reformat_eg_1.png)
...
1. Click the `Advanced` button in the `Reformat UI
   ...
   ![Advanced import toggle](/data-engineering/gems/transform/img/reformat_advanced.png)

2. Enter the expressions into the text area using the format as described below:

   ![Advanced import mode](/data-engineering/gems/transform/img/reformat_advanced_2.png)
