---
title: Unpivot gem for Data Engineering
...
If you want to pivot the data, rather than unpivot, use the [Aggregate](/data-engineering/gems/transform/aggregate) gem.
