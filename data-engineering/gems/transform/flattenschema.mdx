---
title: FlattenSchema gem for Data Engineering
...
![The FlattenSchema gem](/data-engineering/gems/transform/img/flatten_gem.png)
...
![Input schema](/data-engineering/gems/transform/img/flatten_input.png)

And the data looks like so:

![Input data](/data-engineering/gems/transform/img/flatten_input_interim.png)
...
![Adding Expressions](/data-engineering/gems/transform/img/flatten_add_exp.gif)
...
![Output schema](/data-engineering/gems/transform/img/flatten_output.png)

And here's what the output data looks like:

![Output interim](/data-engineering/gems/transform/img/flatten_output_interim.png)
