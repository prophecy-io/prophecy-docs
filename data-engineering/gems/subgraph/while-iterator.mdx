...
- ProphecySparkAlteryxPython 0.0.1+
...
![WhileIterator](/data-engineering/gems/subgraph/img/while-iterator.png)
...
<Info>
  Before setting the WhileIterator configuration, make sure you are familiar with [pipeline
...
![WhileIterator](/data-engineering/gems/subgraph/img/while-iterator-output.png)
