...
First add the Input gem on which you want to Iterate over. For this, simply use an existing dataset or create a new [Source gem](/data-analytics/gems/source-target/source-target) pointing to your Metadata table.
