...
![Create_table_iterator](/data-engineering/gems/subgraph/img/Create_table_iterator.png)
...
![configure_loop](/data-engineering/gems/subgraph/img/Configure_table_iterator.png)

When you check Enable Parallel Execution, you can also control **(1) Number of threads** to run in parallel as shown below.

![loop_settings](/data-engineering/gems/subgraph/img/loop_settings.png)
...
![loop_configs](/data-engineering/gems/subgraph/img/loop_configs.png)
...
![run_loop](/data-engineering/gems/subgraph/img/Run_loop.png)
...
![table_iterator_ports](/data-engineering/gems/subgraph/img/loop_additional_ports.png)
