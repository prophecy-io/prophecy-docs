...
<Accordion title="Cluster requirements">
...
![Create basic subgraph](/data-engineering/gems/subgraph/img/Create_basic_subgraph.png)
...
![Add/Remove port](/data-engineering/gems/subgraph/img/subgraph_additional_ports.png)

## Subgraph Configurations

Subgraphs support configurations just like [pipelines](/data-engineering/development/pipelines/configuration) do. You can apply configurations in two ways:
