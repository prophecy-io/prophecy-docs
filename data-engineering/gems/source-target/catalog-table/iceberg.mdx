...
1. Navigate to **Pipeline Settings**.
   ...
   ![Open Pipeline Settings](/data-engineering/gems/source-target/catalog-table/img/iceberg/open-pipeline-settings.png)

2. In your **Spark** tab, under **Spark Configuration**, add your Spark conf properties.

   ![Spark Pipeline Settings](/data-engineering/gems/source-target/catalog-table/img/iceberg/spark-pipeline-settings.png)
