---
title: XML file gem for Data Engineering
...
| Compression Codec | Compression codec when writing to the XML file. The XML file supports the following codecs: `none`, `bzip2`, `gzip`, `lz4`, `snappy` and `deflate`. | None                                              |
