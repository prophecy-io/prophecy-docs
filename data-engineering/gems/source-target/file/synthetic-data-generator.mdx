...
![img](/data-engineering/gems/source-target/file/img/data-gen/synth_0_datasample.png)

<Info>The Data Generator gem can only be a **Source** gem. It cannot be a Target gem.</Info>

## Cluster requirements

Create a fabric and configure the [Job Size](/data-engineering/fabrics/databricks/databricks), or login to an existing Spark cluster UI. To create a fabric and configure the job size in the Spark Cluster UI:
...
![img](/data-engineering/gems/source-target/file/img/data-gen/synth_0_2_proph_reqiuirements.png)
...
![img](/data-engineering/gems/source-target/file/img/data-gen/synth_3_properties.png)
...
1. Create a Target gem.
   ...
   ![img](/data-engineering/gems/source-target/file/img/data-gen/synth_4_new_target.png)

1. Connect your Source gem to your Target gem.

   ![img](/data-engineering/gems/source-target/file/img/data-gen/synth_5_connect_target.png)
...
1. Configure the `Write Mode` property for the Target gem.
   ...
   ![img](/data-engineering/gems/source-target/file/img/data-gen/synth_6_write_mode.png)

<Info>
  To see if Prophecy supports this gem in the Unity Catalog standard access mode clusters, see
  [Unity Catalog standard cluster support](/data-engineering/fabrics/databricks/UCShared).
</Info>
