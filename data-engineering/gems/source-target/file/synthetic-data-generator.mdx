...
![Data preview](/data-engineering/gems/source-target/file/img/data-gen/synth_0_datasample.png)
...
![Requirements](/data-engineering/gems/source-target/file/img/data-gen/synth_0_2_proph_reqiuirements.png)
...
![Source gem](/data-engineering/gems/source-target/file/img/data-gen/synth_3_properties.png)
...
1. Create a Target gem.
   ...
   ![Target gem](/data-engineering/gems/source-target/file/img/data-gen/synth_4_new_target.png)

1. Connect your Source gem to your Target gem.

   ![Gem connection](/data-engineering/gems/source-target/file/img/data-gen/synth_5_connect_target.png)
...
1. Configure the `Write Mode` property for the Target gem.
   ...
   ![Write modes](/data-engineering/gems/source-target/file/img/data-gen/synth_6_write_mode.png)
