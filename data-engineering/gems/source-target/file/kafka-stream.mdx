...
![Example usage of Filter](/data-engineering/gems/source-target/file/img/kafka_source_eg_1.png)
...
![Example usage of Filter](/data-engineering/gems/source-target/file/img/kafka_target_eg_1.png)
...
![Example usage of Filter](/data-engineering/gems/source-target/file/img/kafka_pipeline_eg.gif)
...
<Note>
  For production workflows the [phase](/data-engineering/gems/gems#gem-phase) for the `Script` gem that updates
