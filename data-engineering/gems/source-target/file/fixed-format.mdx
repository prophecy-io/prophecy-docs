...
![Fixed format source example](/data-engineering/gems/source-target/file/img/fixed-format/ff-source-small.gif)
...
![Fixed format target Example](/data-engineering/gems/source-target/file/img/fixed-format/ff-target-small.gif)
