...
<Info>
  ...
  modes](/data-engineering/fabrics/databricks/UCShared).
</Info>
...
![Lookup UI](/data-engineering/gems/source-target/img/lookup_ui.png)
...
![Reformat example](/data-engineering/gems/source-target/img/lookup_use.png)
