---
title: Join gem for Data Engineering
...
![Example usage of Join - Add new input to join gem](/data-engineering/gems/join-split/img/add_new_input.png)

## Examples

### Example 1 - Join with three DataFrame inputs

![Example usage of Join - Join three DataFrame inputs](/data-engineering/gems/join-split/img/join_without_hints.png)
...
![Example usage of Join - Join with hints](/data-engineering/gems/join-split/img/join_with_hints.png)
