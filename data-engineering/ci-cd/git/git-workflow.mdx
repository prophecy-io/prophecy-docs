...
If you need code reviews or use protected branches like main, you can enable pull requests during the merge step. This lets you open a pull request in your external Git provider directly from Prophecy. To enable and configure this workflow, see [Pull requests](/data-engineering/git-pull-requests/).
