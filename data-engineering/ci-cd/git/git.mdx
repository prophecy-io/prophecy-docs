---
title: Set up Git credentials
sidebarTitle: Credentials
description: Connect external repositories to Prophecy
---
...
<Note>
  You can only edit the credentials you own. You cannot modify credentials that have been shared
  with you.
</Note>
...
Learn more about the [Git workflow](/data-engineering/ci-cd/git/git-workflow) or try it yourself in [Develop and deploy a project](/data-engineering/ci-cd/deployment/deployment).
