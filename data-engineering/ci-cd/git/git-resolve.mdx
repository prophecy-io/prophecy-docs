...
![Choose a Git conflict manual merge](/data-engineering/ci-cd/git/img/git-conflict-manual-merge.png)
...
![View Git conflict merge strategies](/data-engineering/ci-cd/git/img/git-conflict-merge-strategy.png)
...
![View Git conflict merge strategies](/data-engineering/ci-cd/git/img/git-conflict-code-changes.png)
...
![Delete a Git branch](/data-engineering/ci-cd/git/img/git-delete-branch.png)
