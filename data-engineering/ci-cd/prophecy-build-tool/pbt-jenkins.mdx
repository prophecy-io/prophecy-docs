...
![branch_protection_checks_example.png](/data-engineering/ci-cd/prophecy-build-tool/img/branch_protection_checks_example.png)
...
![finding_fabric_id.png](/data-engineering/ci-cd/prophecy-build-tool/img/finding_fabric_id.png)
...
- Create a Jenkins pipeline
  ![jenkins-pipeline-type.png](/data-engineering/ci-cd/prophecy-build-tool/img/jenkins-pipeline-type.png)
...
- Provide credentials to GitHub
  - creating a fine-grained Personal Acces Token (PAT) in GitHub. The PAT should be
    ...
    ![github-pat-permissions.png](/data-engineering/ci-cd/prophecy-build-tool/img/github-pat-permissions.png)
- Choose pipeline Script from SCM
- Provide the path to our Jenkinsfile within the repo

![hello-cicd-declarative-test_configure.png](/data-engineering/ci-cd/prophecy-build-tool/img/hello-cicd-declarative-test_configure.png)
...
![hello-cicd-declarative-test_configure-trigger.png](/data-engineering/ci-cd/prophecy-build-tool/img/hello-cicd-declarative-test_configure-trigger.png)
...
![hello-cicd-declarative-deploy_configure.png](/data-engineering/ci-cd/prophecy-build-tool/img/hello-cicd-declarative-deploy_configure.png)
...
- Create a new webhook like this:
  ![github-push-webhook-config.png](/data-engineering/ci-cd/prophecy-build-tool/img/github-push-webhook-config.png)
