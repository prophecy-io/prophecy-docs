...
![Project Git Flow](/data-engineering/ci-cd/deployment/img/project-git.png)
...
![New project](/data-engineering/ci-cd/deployment/img/new_project_git_credentials.png)
...
![Checkout branch](/data-engineering/ci-cd/deployment/img/checkout-branch.png)
...
![Commit changes](/data-engineering/ci-cd/deployment/img/commit-changes.png)
...
![Merge changes](/data-engineering/ci-cd/deployment/img/merge.png)
...
![Release changes](/data-engineering/ci-cd/deployment/img/release-project.png)
