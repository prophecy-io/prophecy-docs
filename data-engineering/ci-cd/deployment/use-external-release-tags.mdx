...
1. From `...` in the top right corner, select **(1) Deploy**. This opens the Deploy dialog.
   ...
   ![Deploy_button](/data-engineering/ci-cd/deployment/img/external_release_tag_deploy.png)
...
2. Select a release version you wish to deploy by using the **(1) Choose a release** dropdown. Once you select a version, the table below shows the jobs that are going to be modified (there might not be any jobs). Click **(2) Deploy** to start the deployment.
   ...
   ![Deploy_start](/data-engineering/ci-cd/deployment/img/external_release_tag_deploy_start.png)
...
![Add_dependency](/data-engineering/ci-cd/deployment/img/external_release_tag_dependency.png)
...
![Add_dependency_2](/data-engineering/ci-cd/deployment/img/external_release_tag_create_dependency.png)
