...
<AccordionGroup>
<Accordion title="Clear the knowledge graph cache">
...
| ------------------ | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `PROPHECY_PAT`     | Yes                              | [Personal Access Token](/api-reference/introduction#access-tokens) used to authenticate with Prophecy.                                       |
...
![Lineage extractor output](/data-engineering/lineage/img/prophecy-lineage-report-for-pipeline.png)
