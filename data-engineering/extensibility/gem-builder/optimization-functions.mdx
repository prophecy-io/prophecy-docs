...
description: Disable or enable optimizations in your custom gems
---
...
<Note>These functions are Python specific.</Note>
...
![Turn off loop unrolling example](/data-engineering/extensibility/gem-builder/img/turn-off-loop-unrolling.png)
