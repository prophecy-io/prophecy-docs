...
<Info>
  To see an example `dialog()` function, visit [Gem Builder
  reference](/data-engineering/extensibility/gem-builder/gem-builder-reference#dialog-ui).
</Info>

<Tip>
  To reference the complete code of a certain gem, search for the gem using the left sidebar of the
  project editor. Click the gem to open its code, then look for the `dialog()` function. This
...
<Frame>![Checkbox](/data-engineering/extensibility/gem-builder/img/uispec/Checkbox.png)</Frame>
...
<Frame>![Switch](/data-engineering/extensibility/gem-builder/img/uispec/Switch.png)</Frame>
...
<Frame>![TextBox](/data-engineering/extensibility/gem-builder/img/uispec/TextBox.png)</Frame>
...
<Frame>![ExpressionBox](/data-engineering/extensibility/gem-builder/img/uispec/ExpressionBox.png)</Frame>
...
<Frame>![ExpTable](/data-engineering/extensibility/gem-builder/img/uispec/ExpTable.png)</Frame>
...
<Frame>![BasicTable](/data-engineering/extensibility/gem-builder/img/uispec/BasicTable.png)</Frame>
...
<Frame>![TitleElement](/data-engineering/extensibility/gem-builder/img/uispec/TitleElement.png)</Frame>
...
<Frame>![TextArea](/data-engineering/extensibility/gem-builder/img/uispec/TextArea.png)</Frame>
...
<Frame>![SchemaTable](/data-engineering/extensibility/gem-builder/img/uispec/SchemaTable.png)</Frame>
...
<Frame>![Ports](/data-engineering/extensibility/gem-builder/img/uispec/Ports.png)</Frame>
...
<Frame>![SchemaColumnsDropdown](/data-engineering/extensibility/gem-builder/img/uispec/SchemaColumnsDropdown.png)</Frame>
...
<Frame>![SelectBox](/data-engineering/extensibility/gem-builder/img/uispec/SelectBox.png)</Frame>
...
<Frame>![AlertBox](/data-engineering/extensibility/gem-builder/img/uispec/AlertBox.png)</Frame>
...
<Frame>![NumberBox](/data-engineering/extensibility/gem-builder/img/uispec/NumberBox.png)</Frame>
...
<Frame>![Markdown](/data-engineering/extensibility/gem-builder/img/uispec/Markdown.png)</Frame>
...
<Frame>![RadioGroup](/data-engineering/extensibility/gem-builder/img/uispec/RadioGroup.png)</Frame>
...
<Frame>![Editor](/data-engineering/extensibility/gem-builder/img/uispec/Editor.png)</Frame>
