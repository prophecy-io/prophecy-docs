...
| Custom Subgraph (**Python only**) | Controls the flow of gems. Visit the [Subgraph](/data-engineering/gems/subgraph/subgraph) page for an example. | None                                                  |
...
| `customOutputSchemaEnabled` | Enables the [custom schema](/data-engineering/gems/gems#output-ports) option by default in the gem. Requires gemLibsVersion 1.1.47+ for Scala. | Boolean                                | Transformation              |
...
![Dialog](/data-engineering/extensibility/gem-builder/img/gem-builder-ui.png)
