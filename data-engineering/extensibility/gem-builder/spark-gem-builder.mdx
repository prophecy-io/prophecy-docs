...
1. Choose **Transformation Gem** [mode](/data-engineering/gem-builder-reference/#mode).
...
Now that you know how to create Spark gems, have a look at how to [create custom SQL gems](/data-analytics/gem-builder).
