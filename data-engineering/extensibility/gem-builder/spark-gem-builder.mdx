...
[Gems](/data-engineering/gems/gems) are visually-packaged parcels of code that perform specific operations on data. While Prophecy provides many gems out of the box, Prophecy also lets you create your own gems! Not only can you create new gems, but you can also share them in the [Package Hub](/data-engineering/extensibility/package-hub/package-hub) or with selected teams.
...
| Optimize function                               | Enable or disable [code optimization](/data-engineering/extensibility/gem-builder/optimization-functions). |
...
1. Choose **Transformation Gem** [mode](/data-engineering/extensibility/gem-builder/gem-builder-reference#mode).
1. Select the **Transform** category.
1. Click **Create Gem**.

![Create gem](/data-engineering/extensibility/gem-builder/img/create-gem.png)
...
![UI](/data-engineering/extensibility/gem-builder/img/UI.png)
...
![8](/data-engineering/extensibility/gem-builder/img/8-gm.png)
...
![9](/data-engineering/extensibility/gem-builder/img/9-gm.png)
...
![5](/data-engineering/extensibility/gem-builder/img/5-gm.png)
