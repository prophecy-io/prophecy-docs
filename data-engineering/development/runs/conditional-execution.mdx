...
description: Conditionally run or skip transformations within pipelines
---
...
![Add a condition](/data-engineering/development/runs/img/add-condition.png)
...
![Remove condition on Target gem](/data-engineering/development/runs/img/remove-condition.png)
