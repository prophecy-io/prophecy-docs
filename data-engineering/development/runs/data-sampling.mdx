...
1. When data sampling is on, select your [preferred mode](#data-sampling-modes) from the **Data Sampling** dropdown.

![Interactive run configuration](/data-engineering/development/runs/img/interactive-run-config.png)
...
![Selective](/data-engineering/development/runs/img/selective-interims.png)
...
![Cached interims](/data-engineering/development/runs/img/cached-interims.png)
...
![Gem menu with Record Count checkbox](/data-engineering/development/runs/img/gem-menu.png)
...
![Pipeline with record count enabled](/data-engineering/development/runs/img/record-count.png)
...
![Create a new model test](/data-engineering/development/runs/img/limit-data-preview-interims.png)
