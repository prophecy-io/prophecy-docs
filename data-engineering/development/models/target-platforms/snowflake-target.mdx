...
For a complete guide to defining how to write target tables, visit [Write strategies](/data-analysis/gems/source-target/table/write/write-options).

## Data Tests

A data test is an assertion you define about a dataset in your project. Data tests are run on target models to ensure the quality and integrity of the final data that gets written to the warehouse. Learn how to build tests in [Table tests](/data-analysis/development/tests/table-tests).
