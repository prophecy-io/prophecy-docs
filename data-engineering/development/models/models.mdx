---
title: What are SQL models?
description: Models define a single target table or view in a SQL warehouse
---
...
<Tip>
  While you can develop models visually using gems, you can also write models directly in the code
  view, which is automatically synced with the visual view.
</Tip>
...
1. Open the project settings menu beside the project name.
1. Select **Advanced Settings**.
1. Choose to edit the Project Settings, Folder Settings, or Model Settings.

![Advanced Settings](/data-engineering/development/models/img/advanced-settings-dbt.png)

<Note>Folder Settings only apply to directories that contain models.</Note>

## Schedule models

To schedule automated model execution:

- The project must use the [Normal Git Storage Model](/data-analysis/development/versioning/version-control).
- You need to use an external orchestrator, such as [Databricks Jobs](/data-engineering/orchestration/databricks-jobs) or Apache Airflow DAGs.
...
Many visual transformations in pipelines are compiled into models under the hood. If you are working on a pipeline, you can view and edit the code of underlying dbt models in a pipeline. However, you cannot visually edit these underlying models.

To view these models, select **Show Models** from the project interface.

{/* TODO: Confirm where Show Models appears after the Project Browser settings update. */}

![Show Models](/data-engineering/development/models/img/show-models.png)
