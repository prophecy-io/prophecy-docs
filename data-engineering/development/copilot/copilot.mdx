...
<Info>
  The Spark Copilot fetches context from environment metadata only. The Spark Copilot does not use
  knowledge graphs, which additionally store metadata relationships.
</Info>
