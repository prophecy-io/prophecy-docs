...
description: Learn about transformations in streaming data
---
...
![Example usage of Watermark - Watermark Table](/data-engineering/development/spark-streaming/img/watermarkinputoutput.png)
...
- [SQL Statement](/data-engineering/gems/custom/sql-statement)
