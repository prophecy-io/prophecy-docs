...
![Pipeline schema](/data-engineering/development/pipelines/img/configuration/project-pipeline-config.png)
...
| Optional    | Indicates whether the variable is optional. If not selected, you must provide a default value for the config. |
| Description | An optional text field to provide additional context or details about the variable.                           |

<AccordionGroup>
<Accordion title="Expand to see the list of supported data types">
...
Depending on the Visual Language configured in your [Pipeline Settings](/data-engineering/development/pipelines/pipeline-settings), you can also use that language's syntax to call variables.
...
![Choose config for interactive run](/data-engineering/development/pipelines/img/configuration/configuration-interactive-run.png)
...
![Choose config for job execution](/data-engineering/development/pipelines/img/configuration/configuration-job.png)

## Subgraph configurations

[Subgraphs](/data-engineering/gems/subgraph/subgraph) can have their own dedicated configurations that control behavior within the subgraph's scope. This allows you to create reusable pipeline components with their own configurable parameters. To add configs to a subgraph:
...
![Subgraph configuration](/data-engineering/development/pipelines/img/configuration/config-subgraph.png)
...
<Tab title="Scala configuration code">
...
![Config scala code](/data-engineering/development/pipelines/img/configuration/config-scala-code.png)

</Tab>

<Tab title="Python configuration code">
...
![Config python code](/data-engineering/development/pipelines/img/configuration/config-python-code.png)
