...
<Info>
Databricks policies differ from cluster access modes. View [UC cluster compatibility](UCShared.mdx) for more information on standard vs. dedicated cluster capabilities.
</Info>
