...
1. Navigate to allowlist in Databricks.
   ...
   ![Databricks allow list](/data-engineering/fabrics/img/dbx-allowlist.png)
...
Run the following in the command line to whitelist a volume path for JARs. This is relevant if you have [set up Prophecy libraries in a Databricks volume](/data-engineering/fabrics/databricks/volumes-plibs).
