...
![Job Size configuration](/data-engineering/fabrics/img/dbx-job-size.png)
...
<Warning>
When using Unity Catalog clusters with standard (formerly shared) access mode, note their [particular limitations](https://docs.databricks.com/en/compute/access-mode-limitations.html#shared-access-mode-limitations-on-unity-catalog). You can see all supported Prophecy features in our [UC standard cluster support](/data-engineering/fabrics/databricks/UCShared) documentation.
...
<Info>
  ...
  paths](/data-engineering/fabrics/databricks/whitelist-plibs).
</Info>
...
<Note>
  ...
  volumes](/data-engineering/fabrics/databricks/volumes-plibs).
</Note>
...
![Artifact settings](/data-engineering/fabrics/img/dbx-fabric-settings.png)
