...
sidebarTitle: ProphecyLibs in volumes
...
To whitelist the Init Script and the JAR path, follow the instructions to [add Prophecy libraries to your Databricks allowlist](/data-engineering/fabrics/databricks/whitelist-plibs).
