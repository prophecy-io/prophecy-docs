...
To connect EMR and Prophecy, you must create a fabric. You can either create an EMR fabric (suggested), or a [Livy fabric](livy.mdx).
...
<Tabs>
  <Tab title="EMR">
    ...
    1. Add the job size to your environment by clicking on **Add job Size**. [Configure your job size](emr-job-sizes.mdx) and click on **Add**.
