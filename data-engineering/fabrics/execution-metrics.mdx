...
description: Track pipeline performance data
---
...
<Note>Execution metrics are available for Spark pipelines only.</Note>
...
<AccordionGroup>
<Accordion title="Create pipeline metrics table">
...
<Accordion title="Create component metrics table">
...
<Accordion title="Create interims table">
...
<Accordion title="Grant permissions on these tables">
...
<Accordion title="Create components metrics table">
...
![Pipeline_Execution_Metrics](/data-engineering/fabrics/spark-provider/img/execution-metrics-pipeline.png)
...
![Dataset_metrics](/data-engineering/fabrics/spark-provider/img/execution-metrcis-dataset1.png)
...
![ExecutionMetricsConfig.png](/data-engineering/fabrics/spark-provider/img/ExecutionMetricsConfig.png)
