---
title: Livy
description: Set up a Livy fabric
---
...
Connections are not supported for Livy fabrics. However, you can still add secrets to your fabric. Team admins can learn how to set up and use secrets [here](/data-analytics/environment/secrets/secrets).
