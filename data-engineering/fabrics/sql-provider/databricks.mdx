...
<Warning>
  ...
  fabric](/data-analysis/environment/fabrics/prophecy-fabrics) with a Databricks SQL warehouse
...
![Provider](/data-engineering/fabrics/sql-provider/img/DatabricksFabric2.png)
