...
1. Select a [team](/data-analysis/administration/management/teams/teams) to own this fabric. Open the dropdown to see the teams you belong to.
1. Click **Continue**.
...
![Provider](/data-engineering/fabrics/sql-provider/img/SnowflakeFabric2.png)
