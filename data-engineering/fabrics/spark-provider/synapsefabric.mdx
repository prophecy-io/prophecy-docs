---
title: Create an Azure Synapse fabric
...
Your fabric for Azure Synapse fabric is configured! Try creating a cluster using the fabric that you've just created and attach to it.
