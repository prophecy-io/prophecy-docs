...
description: Set up AWS EMR authentication using Okta
---
...
1. For **Single Sign-On URL**, open the Prophecy EMR fabric where you want to configure SAML.
   ...
   ![Prophecy EMR Fabric](/data-engineering/fabrics/spark-provider/emr/img/emr-saml-setup.png)
...
1. Copy the **Metadata URL** details.
   ...
   ![Okta metadata](/data-engineering/fabrics/spark-provider/emr/img/okta-metadata.png)
...
1. For **Metadata document**, upload the `metadata.xml` file you downloaded earlier.
   ...
   ![AWS provider](/data-engineering/fabrics/spark-provider/emr/img/aws-new-idp.png)
...
1. For **SAML 2.0-based provider**, choose the provider created in the previous section.
...
1. In Prophecy, [complete the fabric configuration](/data-engineering/fabrics/spark-provider/emr/emr) and save it.
