...
<Info>
  Databricks policies differ from cluster access modes. View [UC cluster
  compatibility](/data-engineering/fabrics/spark-provider/databricks/UCShared) for more information
  on standard vs. dedicated cluster capabilities.
</Info>
