...
Once you have developed a [Spark pipeline](/data-engineering/development/pipelines/pipelines) using Prophecy, you will want to schedule it to run at
...
| Fabric                    | The [execution fabric](/data-engineering/fabrics/spark-provider/databricks/databricks) to which the job will be deployed.                                                                                                                                                       |
| Job Size                  | The [default size](/data-engineering/fabrics/spark-provider/databricks/databricks) of the cluster that will be created for the job.                                                                                                                                             |
...
<Note>
  **Note:** The Model Gem refers to _data models_ (SQL/dbt) rather than machine learning models. It
...
![Jobs Monitoring Modal](/data-engineering/orchestration/img/databricks-job-monitoring.png)
...
In order to deploy the job on Databricks, you need to release and deploy the job from Prophecy. See [Deployment](/data-engineering/ci-cd/deployment/deployment) for more details.
...
1. [How to design a reliable CI/CD process?](/data-engineering/ci-cd/reliable-ci-cd)
