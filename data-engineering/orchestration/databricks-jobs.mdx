...
| Fabric                    | The [execution fabric](/data-engineering/fabrics/databricks/databricks) to which the job will be deployed.                                                                                                                                                                      |
| Job Size                  | The [default size](/data-engineering/fabrics/databricks/databricks) of the cluster that will be created for the job.                                                                                                                                                            |
