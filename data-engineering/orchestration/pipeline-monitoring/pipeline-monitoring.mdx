...
- [Enable Pipeline Monitoring](/data-engineering/orchestration/pipeline-monitoring/enable-pipeline-monitoring)
- [Use Pipeline Monitoring](/data-engineering/orchestration/pipeline-monitoring/use-pipeline-monitoring)

For information on the stored execution metrics, see [Execution Metrics](/data-engineering/fabrics/execution-metrics).
