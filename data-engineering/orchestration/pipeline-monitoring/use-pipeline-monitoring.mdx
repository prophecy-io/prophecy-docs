...
![Gem failure-details](/data-engineering/orchestration/pipeline-monitoring/img/gem-failure-details.png)
...
![View runtime logs](/data-engineering/orchestration/pipeline-monitoring/img/view-runtime-logs.png)
...
![View and fix problems with AI](/data-engineering/orchestration/pipeline-monitoring/img/view-and-fix-problems.png)
...
![View run history](/data-engineering/orchestration/pipeline-monitoring/img/view-run-history.png)

<Note>
  It may take a moment to load the Historical View since Prophecy is using your cluster to fetch the
  historical run information from your table.
</Note>
...
![Historical monitoring options and details](/data-engineering/orchestration/pipeline-monitoring/img/historical-monitoring-options.png)
