...
Given a Scala pipeline named "demo_pipeline" with a JAR artifact from [PBT](/data-engineering/ci-cd/prophecy-build-tool/prophecy-build-tool)
...
Given a PySpark pipeline named "demo_pipeline" with a WHL artifact from [PBT](/data-engineering/ci-cd/prophecy-build-tool/prophecy-build-tool)
