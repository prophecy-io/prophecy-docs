...
This page describes how to trigger jobs using the [Script job gem](/data-engineering/orchestration/databricks-jobs#script-gem). You can also use the [RunJob job gem](/data-engineering/orchestration/databricks-jobs#runjob-gem) to trigger jobs. See [Databricks jobs](/data-engineering/orchestration/databricks-jobs) for more information.

## Time-based Approach

![Data pipeline](/data-engineering/orchestration/img/jobs-tigger-time-based.png)
...
![Data pipeline](/data-engineering/orchestration/img/jobs-tigger-trigger-based.png)
