...
<Callout icon="/images/icon.png" color="#FFC107">
  Follow this quickstart on the [Enterprise Edition](/getting-started/editions/) only.
</Callout>
...
For this quickstart, you'll create a [Seed](/engineers/seed) as the data source.
