---
title: Quickstart for Data Engineering
description: Create a Spark pipeline for data engineering
---

<Callout icon="/images/icon.png" color="#FFC107">
  Follow this quickstart on the [Enterprise
  Edition](/data-engineering/administration/platform/editions) only.
</Callout>
...
- A configured [fabric](/data-engineering/fabrics/spark-provider/databricks/databricks) (your execution environment).

If you need a fabric, you have a few options:

- Create a fabric that connects to [Prophecy-managed Databricks](/data-engineering/fabrics/spark-provider/prophecy-managed). Free trial users will automatically have this fabric.
- Ask a [team admin](/data-engineering/administration/management/teams/teams) to create a fabric for you that connects to an existing external Spark engine.
...
For this quickstart, you'll create a [Seed](/data-engineering/gems/source-target/file/seed) as the data source.
...
Now, you'll configure your first data transformation using the [Reformat](/data-engineering/gems/transform/reformat) gem.
...
<Note>By default, gem expressions expect Spark SQL code.</Note>

## Generate data previews

At this point, you may be curious to know what your data looks like. Generate [data previews](/data-engineering/development/data-explorer/data-explorer) with the following steps:
...
- Discover the different [Spark gems](/data-engineering/gems/gems) that you can use for data transformation
- [Reach out to us](/data-engineering/administration/getting-help/get-in-touch) if you need additional help or guidance
