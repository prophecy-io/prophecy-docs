...
Properties for OAuth secrets are specified in the `properties` object when creating or updating a secret. OAuth secrets store OAuth 2.0 client credentials including client ID, client secret, and authorization URL.
