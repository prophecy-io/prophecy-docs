...
<Tip>
  Create the secrets containing your Azure client secret and OneDrive username in Prophecy before
  creating the OneDrive connection. All secrets must be of type `text` and contain their respective
  values.
</Tip>
