...
| Deployment model   | SaaS only. Learn more in [Deployment models](/administration/platform/prophecy-deployment).   |
...
| Version control        | Git integration supporting both Prophecy-managed and external Git repositories.                                        |
| Deployment model       | Dedicated SaaS only. Learn more in [Deployment models](/administration/platform/prophecy-deployment). |
...
| Version control  | Git integration supporting both Prophecy-managed and external Git repositories.                                                                                                                                                                                                               |
| Deployment model | Dedicated SaaS preferred and SaaS available. Learn more in [Deployment models](/administration/platform/prophecy-deployment).                                                                                                                                                |
