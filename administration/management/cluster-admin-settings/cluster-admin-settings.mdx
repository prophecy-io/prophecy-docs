...
[Prophecy cluster admins](/administration/management/users/access/role-based-access) have access to additional settings in the **Settings** UI of their Prophecy environment.
