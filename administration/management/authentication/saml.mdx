...
![SSO settings for SAML and SCIM configurations](/administration/management/authentication/img/sso-scim.png)
...
![AzureAD config example](/administration/management/authentication/img/azure_enterpriseapp_sso.png)
...
![Okta config example](/administration/management/authentication/img/okta_example.png)
...
![Download Okta Cert](/administration/management/authentication/img/okta_dl_cert.png)
...
![IdP Metadata](/administration/management/authentication/img/okta_idp_metadata_xml.png)
...
![SAML Assertion](/administration/management/authentication/img/okta_xml.png)
