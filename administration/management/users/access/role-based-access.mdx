...
- **Prophecy cluster admins ([Enterprise](/administration/platform/editions) only)**: Administer the overall Prophecy deployment and infrastructure
...
Team admins manage teams and create resources for their [teams](/administration/management/teams/teams). This includes responsibilities like:
...
- **([Professional Edition](/administration/platform/editions) only)** Managing usage and billing for the team
