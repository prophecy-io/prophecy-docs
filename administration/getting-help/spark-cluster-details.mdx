...
| ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Overall cluster configuration (e.g., Spark version, Databricks runtime version, UC dedicated or UC standard)                          | <br />![Cluster configuration example](/administration/getting-help/img/cluster_1.png)<br />      |
| Cluster JSON (edited to remove any private or sensitive information)                                                                  | <br />![Cluster JSON example](/administration/getting-help/img/cluster_2.png)<br />               |
| Libraries installed on the cluster                                                                                                    | <br />![Cluster libraries example](/administration/getting-help/img/cluster_3.png)<br />          |
| Init scripts run on the cluster. Include the script itself if possible.                                                               | <br />![Cluster init scripts example](/administration/getting-help/img/cluster_4.png)<br />       |
| Output of attaching cluster in a notebook. You may need to duplicate the tab and try attaching the same cluster in the duplicate tab. | <br />![Notebook attach to cluster example](/administration/getting-help/img/cluster_5.png)<br /> |
