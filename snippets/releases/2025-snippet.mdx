...
Now, when you configure a chart in a [Prophecy App](/data-analysis/production/analysis/overview) or in the [Data Explorer](/data-analysis/development/runs/data-explorer/data-explorer), you can change the colors used in the chart.
...
- You can now enable or disable [auto-run](/data-analysis/production/analysis/analysis-settings) for Prophecy Apps in the app settings.
...
- You can now overwrite a Table gem using the [File Upload component](/data-analysis/production/analysis/analysis-components#file-upload) in a Prophecy App. Previously, you could only overwrite Source gems. (Added in 4.1.2.2).
