...
Prophecy now persists runtime logs and historical run data indefinitely. This way, you can audit your pipeline runs from all time. Learn more about [runtime logs](/data-analysis/development/runs/runtime-logs) and [observability](/data-analysis/production/monitoring).
