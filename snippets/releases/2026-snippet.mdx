...
The [**Condition** gem] routes rows to one of multiple outputs based on user-defined conditions. Each row is evaluated in order and routed to the first matching output.
