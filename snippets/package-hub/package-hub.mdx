...
![Package Hub landing page](/snippets/package-hub/img/package-hub.png)
...
1. Release the project (create a new project version).
1. Share your project with other teams in the Access tab of the project metadata page.
...
![Publish to Package Hub](/snippets/package-hub/img/package-hub-publish.png)
...
![Import from Package Hub](/snippets/package-hub/img/package-hub-import.png)
...
<Info>
  ...
  reference](/data-analytics/gems/gems).
</Info>
