...
- **LLM**: Enterprise Edition requires a customer-provided LLM endpoint to power [Prophecy AI](/data-analysis/ai/llm-providers).
...
- [Prophecy fabrics](/data-analysis/environment/fabrics/prophecy-fabrics): Use Prophecy Automate with an external SQL warehouse to run pipelines.
