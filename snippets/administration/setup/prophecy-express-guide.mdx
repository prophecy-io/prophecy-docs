...
For more information about AI model support, visit [Prophecy AI](/data-analysis/ai/llm-providers).
...
Express Edition supports Single Sign-On (SSO) integration with Okta. Learn more about setting up Okta in our [SAML documentation](/data-analysis/administration/management/authentication/saml#set-up-saml).
...
- Create a [Prophecy fabric](/data-analysis/environment/fabrics/prophecy-fabrics). You can only create fabrics for teams where you are the [team admin](/data-analysis/administration/management/users/access/role-based-access).
