...
- Create a [Prophecy fabric](/data-analytics/environment/fabrics/prophecy-fabrics). You can only create fabrics for teams where you are the [team admin](/administration/rbac).
