...
To automatically create new teams in Prophecy via [group mappings](/data-engineering/administration/management/authentication/group-team-mapping), follow these steps.

1. In your Prophecy deployment, set the `ENABLE_AUTO_TEAM_CREATION` flag to `true`.
1. Open the Azure portal.
1. Open the app that you registered in [1. Register a new app](#1-register-a-new-app).
