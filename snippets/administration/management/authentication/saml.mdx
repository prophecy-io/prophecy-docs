...
![./img/sso-scim.png](/snippets/administration/management/authentication/SSO settings for SAML and SCIM configurations)
...
![./img/azure_enterpriseapp_sso.png](/snippets/administration/management/authentication/AzureAD config example)
...
![./img/okta_example.png](/snippets/administration/management/authentication/Okta config example)
...
![./img/okta_dl_cert.png](/snippets/administration/management/authentication/Download Okta Cert)
...
![./img/okta_idp_metadata_xml.png](/snippets/administration/management/authentication/IdP Metadata)
...
![./img/okta_xml.png](/snippets/administration/management/authentication/SAML Assertion)
