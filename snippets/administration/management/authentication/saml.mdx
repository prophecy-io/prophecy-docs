...
- To access SSO settings, you must be a [cluster admin](/data-engineering/administration/management/users/access/role-based-access) for your deployment.
- SAML is available for [Express and Enterprise Editions](/data-engineering/administration/platform/editions).
- SCIM is only available for the [Enterprise Edition](/data-engineering/administration/platform/editions). To enable SCIM in your environment, update the `config` in your Prophecy deployment.
...
![SSO settings for SAML and SCIM configurations](/snippets/administration/management/authentication/img/sso-scim.png)
...
After completing these steps, you'll create users and groups in your IdP directly. See [Group-to-team mapping](/data-engineering/administration/management/authentication/group-team-mapping) to learn about group naming conventions.
...
![AzureAD config example](/snippets/administration/management/authentication/img/azure_enterpriseapp_sso.png)
...
1. From the left menu of the same provisioning page, navigate to **Manage > Users and groups**.
   - Create groups using Prophecy's [naming conventions](/data-engineering/administration/management/authentication/group-team-mapping).
...
![Okta config example](/snippets/administration/management/authentication/img/okta_example.png)
...
![Download Okta Cert](/snippets/administration/management/authentication/img/okta_dl_cert.png)
...
![IdP Metadata](/snippets/administration/management/authentication/img/okta_idp_metadata_xml.png)
...
![SAML Assertion](/snippets/administration/management/authentication/img/okta_xml.png)
...
1. Create users and assign them to groups using Prophecy's [naming conventions](/data-engineering/administration/management/authentication/group-team-mapping).
