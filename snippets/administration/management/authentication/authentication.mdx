<Callout icon="/images/icon.png" color="#FFC107">
  ...
  Custom authentication is available for the [Enterprise and Express Editions](/data-engineering/administration/platform/editions) only.
...
Only [Prophecy cluster admins](/data-engineering/administration/management/users/access/role-based-access) have permission to view and edit SSO settings.
...
To set up OAuth for fabric connection authentication, see [OAuth app registrations](/data-engineering/administration/management/cluster-admin-settings/oauth-setup).
