...
Prophecy supports automatic team creation and user role assignment based on identity provider groups using either SCIM or LDAP. To learn about roles in Prophecy, visit [Role-based access](/data-engineering/administration/management/users/access/role-based-access).
...
<Info>Please reach out to us to set up these configurations.</Info>
...
<Tip>You can use regular expressions for the prefix value.</Tip>
