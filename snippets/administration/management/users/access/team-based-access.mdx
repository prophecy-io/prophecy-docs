...
![Relationship between users, teams, projects, and fabrics](/snippets/administration/management/users/access/img/project-fabric-team.png)
...
<Note>
  [Team admins](/data-engineering/administration/management/users/access/role-based-access) have
  special privileges for managing team membership and team fabric creation, but the core access
  model remains focused on the team-to-resource relationship. Each team can be assigned to many
  projects and fabrics, but importantly, each project and fabric can only be assigned to one team.
</Note>
...
- Run [Prophecy Apps](/data-analytics/collaboration/prophecy-apps/apps)
...
<Note>
  Authentication capabilities vary between different connection types across fabrics. Visit
  individual connection documentation to learn about the specific authentication strategies
...
Here is one example of how you may configure a [Prophecy fabric](/data-analytics/environment/fabrics/prophecy-fabrics) for development.

![Development fabric](/snippets/administration/management/users/access/img/fabric-dev.png)
...
Here is one example of how you may configure a [Prophecy fabric](/data-analytics/environment/fabrics/prophecy-fabrics) for production.

![Production fabric](/snippets/administration/management/users/access/img/fabric-prod.png)
...
- You can import project components into your own projects through the [Package Hub](/data-engineering/extensibility/package-hub/package-hub).
- You can run [Prophecy Apps](/data-analytics/collaboration/prophecy-apps/apps) built on top of project pipelines.
...
<Note>Prophecy Apps are only available for SQL projects at this time.</Note>
...
![Attach different fabrics to a project](/snippets/administration/management/users/access/img/project-fabric-attachment.png)

<Info>
  To accomplish the scenario above, you must ensure that at least one user is a member of both the
  project's team and the target fabric's team. This way, someone will be able to publish or deploy a
  project to production environments.
</Info>
...
<Note>
  Python and Scala projects do not specify "providers" at creation. These projects can connect to
  any Spark fabric.
</Note>
