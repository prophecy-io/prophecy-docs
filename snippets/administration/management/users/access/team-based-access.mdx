...
- Run [Prophecy Apps](/data-analysis/production/analysis/overview)
...
- You can run [Prophecy Apps](/data-analysis/production/analysis/overview) built on top of project pipelines.
