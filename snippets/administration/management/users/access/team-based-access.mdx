...
<Frame>
  ![Relationship between users, teams, projects, and
  fabrics](/snippets/administration/management/users/access/img/project-fabric-team.png)
</Frame>
...
<Frame>
  ![Attach different fabrics to a
  project](/snippets/administration/management/users/access/img/project-fabric-attachment.png)
</Frame>
