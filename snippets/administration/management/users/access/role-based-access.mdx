...
- **Prophecy cluster admins ([Enterprise](/data-engineering/administration/platform/editions) only)**: Administer the overall Prophecy deployment and infrastructure
...
<Info>
  For more information about best practices, visit [Team-based
...
Team admins manage teams and create resources for their [teams](/data-analytics/administration/management/teams/teams). This includes responsibilities like:
...
- **([Professional Edition](/data-engineering/administration/platform/editions) only)** Managing usage and billing for the team
...
<Note>
  For recommendations regarding team setup and organization, visit [Team-based
  access](/data-engineering/administration/management/users/access/team-based-access).
</Note>
