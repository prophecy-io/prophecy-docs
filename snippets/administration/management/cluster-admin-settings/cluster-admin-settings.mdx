...
Available on the [Enterprise Edition](/data-analytics/administration/platform/editions) only.

</Callout>

[Prophecy cluster admins](/data-analytics/administration/management/users/access/role-based-access) have access to additional settings in the **Settings** UI of their Prophecy environment.
