---
title: Configure Claude providers in Prophecy
description: Configure Anthropic or Azure AI Foundry as the provider for Claude using Transform Agent settings.
---
