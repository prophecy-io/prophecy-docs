...
- The [SaaS](/data-analysis/administration/platform/prophecy-deployment#saas) deployment uses a Prophecy-managed OpenAI subscription with GPT-4o and GPT-4o mini.
...
<Info>
  See [Prophecy AI](/data-analysis/ai/llm-providers) for a list of supported LLM providers and
  models.
</Info>
