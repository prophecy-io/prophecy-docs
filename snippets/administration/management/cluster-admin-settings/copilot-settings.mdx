...
- The [SaaS](/data-analytics/administration/platform/prophecy-deployment#saas) deployment uses a Prophecy-managed OpenAI subscription with GPT-4o and GPT-4o mini.
- [Dedicated SaaS](/data-analytics/administration/platform/prophecy-deployment#dedicated-saas) deployments connect to customer-managed endpoints.
...
<Info>
  See [Prophecy AI](/data-analytics/ai/llm-providers) for a list of supported LLM providers and
  models.
</Info>
...
<Note>
  When editing the credentials in Prophecy, you will not be able to see previously-entered values.
