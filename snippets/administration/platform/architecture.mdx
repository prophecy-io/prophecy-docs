...
<Info>
Prophecy Automate is only accessible via [Prophecy fabrics](/data-analytics/environment/fabrics/prophecy-fabrics) for SQL projects and does not integrate with Spark-based projects.
</Info>
