...
| PrivateLink |  |  | ✔ | ✔ |
| Google SSO | ✔ | ✔ | ✔ | ✔ |
| Additional [authentication](/data-engineering/administration/management/authentication/authentication) providers |  |  | ✔ | ✔ |
| Automatic team creation using [SCIM](/data-analysis/administration/management/authentication/saml) |  |  |  | ✔ |
| Bring Your Own Key (BYOK) |  |  |  | ✔ |
| Audit log access |  |  |  | ✔ |
| **Compute** | | | | |
| [Prophecy Automate](/data-engineering/administration/platform/architecture) | ✔ | ✔ | ✔ | ✔ |
