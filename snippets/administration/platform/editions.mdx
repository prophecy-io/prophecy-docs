...
| Category | Feature | Free | Professional | Express | Enterprise |
| --- | --- | --- | --- | --- | --- |
| **Deployment** | SaaS (Multi-tenant) deployment model | ✔ | ✔ |  |  |
...
|  | PrivateLink |  |  | ✔ | ✔ |
|  | Google SSO | ✔ | ✔ | ✔ | ✔ |
|  | Additional [authentication](/data-engineering/administration/management/authentication/authentication) providers for SSO |  |  | ✔ | ✔ |
|  | Automatic team creation using [SCIM](/data-analysis/administration/management/authentication/saml) |  |  |  | ✔ |
|  | Bring Your Own Key (BYOK) |  |  |  | ✔ |
|  | Audit log access |  |  |  | ✔ |
| **Compute** | [Prophecy Automate](/data-engineering/administration/platform/architecture) | ✔ | ✔ | ✔ | ✔ |
...
| **Platform features** | Git-hosted projects | ✔ | ✔ | ✔ | ✔ |
|  | Build custom gems | ✔ | ✔ | ✔ | ✔ |
|  | Analysis dashboards | ✔ | ✔ | ✔ | ✔ |
...
|  | Models (dbt) |  |  |  | ✔ |
|  | Transpiler |  |  | ✔ | ✔ |
| **Project sharing** | Share by adding users to the project's team | ✔ | ✔ | ✔ | ✔ |
|  | Public link sharing | ✔ | ✔ |  |  |
