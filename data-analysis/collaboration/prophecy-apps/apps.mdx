...
![Prophecy App Example](/data-analysis/collaboration/prophecy-apps/img/prophecy-apps-example.png)
...
<Note>
  Learn more about running apps in this
  [guide](/data-analysis/collaboration/prophecy-apps/run-apps).
</Note>
...
If you want to build an app and turn your pipelines into simple, form-based tools that anyone on your team can use, follow our guide to [create a Prophecy App](/data-analysis/collaboration/prophecy-apps/app-creation).
