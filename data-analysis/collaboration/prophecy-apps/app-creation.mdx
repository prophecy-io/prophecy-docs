...
When creating a Prophecy App, structure it using [pipeline parameters](/data-analysis/development/pipeline-params). Pipeline parameters allow applications to dynamically adjust values during execution. By adding [interactive components](/data-analysis/collaboration/prophecy-apps/app-components) to your apps, users can define parameter values while keeping the rest of the pipeline unchanged.
...
![Run Prophecy App results](/data-analysis/collaboration/prophecy-apps/img/prophecy-app-run.png)
...
![App pipeline](/data-analysis/collaboration/prophecy-apps/img/app-pipeline.png)
...
![Create pipeline parameter dialog](/data-analysis/collaboration/prophecy-apps/img/pipeline-parameter.png)
...
![Configure visual expression to use parameter](/data-analysis/collaboration/prophecy-apps/img/visual-expression-parameter.png)
...
![Prophecy App template](/data-analysis/collaboration/prophecy-apps/img/prophecy-app-template.png)
...
To explore advanced configuration options and scheduling capabilities, refer to the documentation on [running apps](/data-analysis/collaboration/prophecy-apps/run-apps).
...
To address your specific business requirements, leverage more complex [components](/data-analysis/collaboration/prophecy-apps/app-components) to construct robust Prophecy Apps.
