---
title: Connect to Azure Data Lake Storage
...
| Feature                                                                                                                                | Supported |
| -------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| Read data with a [Source gem](/data-analysis/gems/source-target/file/adls)                                                             | Yes       |
| Write data with a [Target gem](/data-analysis/gems/source-target/file/adls)                                                            | Yes       |
