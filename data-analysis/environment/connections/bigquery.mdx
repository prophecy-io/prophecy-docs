...
| [Read](/data-analysis/gems/source-target/table/bigquery-read) and [write](/data-analysis/gems/source-target/table/bigquery-write) data with a Table gem   | Yes                                 | No |
