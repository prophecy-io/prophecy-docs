...
| Feature                                                                                    | Supported |
| ------------------------------------------------------------------------------------------ | --------- |
| Read data with a [Source gem](/data-analysis/gems/source-target/external-table/redshift)   | Yes       |
| Write data with a [Target gem](/data-analysis/gems/source-target/external-table/redshift)  | Yes       |
...
| Password ([Secret required](/data-analysis/environment/secrets/secrets)) | Your Redshift password                                                                                   |
