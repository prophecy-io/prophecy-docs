...
Once you create pipeline parameters, they are available as _configuration variables_ in [gems](/data-analysis/gems/gems) wherever you can select a visual expression. You can also reference pipeline parameters using Jinja syntax in code expressions.
