...
- The original project must be a SQL project that uses the [Simple Git Storage Model](/data-analysis/development/versioning/version-control#version-control-options).
