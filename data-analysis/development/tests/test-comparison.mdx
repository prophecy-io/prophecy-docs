...
1. Create a new test definition.
   ...
   ![Equal row count table test](/data-analysis/development/tests/img/table-test-equal-row-count.png)
...
4. Add the test to a table in a pipeline.
   ...
   ![Applying the table test to compare customers and customers_cleaned tables](/data-analysis/development/tests/img/apply-equal-row-count.png)
...
<Frame>
  <img
    src="/data-analysis/development/tests/img/project-test-equal-row-count.png"
