...
This page describes how to operationalize existing parameters in your pipeline for [analysis dashboards](/data-analysis/production/analysis/overview) or [deployment](data-analysis/production/publication).
...
You can now select the parameter in an [analysis dashboard](/data-analysis/production/analysis/overview) so that end users can select the regions they want to see in a report.

1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `regional_sales` pipeline.
...
1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `sales_snapshot` pipeline.
2. Add a title.
...
1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `customer_segment` pipeline.
2. Add a title for the analysis.
...
1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `reviews` pipeline.
2. Add a **Title** for the analysis.
...
1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `products_with_reviews` pipeline.
2. Add a title for the analysis.
...
1. Create an [analysis](/data-analysis/production/analysis/create-analysis) for the `usage_cap_monitor` pipeline.
2. Add a title for the analysis.
3. Select **Interactive > Number Input**.
