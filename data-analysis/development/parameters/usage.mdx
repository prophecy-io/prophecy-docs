...
By default, the parameter's value will be used for the expression, though this value can be overwritten in both pipeline gems and analysis dashboards.
...
## Use parameters in analysis dashboards

Parameters are useful in both [creating](/data-analysis/production/analysis/create-analysis) and [consuming](/data-analysis/production/analysis/consume-analysis) analysis dashboards. To use parameters in an analysis, add an input field and select the parameter for **Configuration field**.
...
### Create an analysis dashboard to adjust region filters
...
### Create an analysis dashboard with date fields
...
### Create an analysis dashboard to select customer groups
...
### Create an analysis dashboard to show archived data
...
### Create an analysis dashboard to show discounted products
...
### Create an analysis dashboard to adjust the cap
...
### Create an analysis dashboard to adjust sensitivity
