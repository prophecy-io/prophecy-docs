...
Parameters are useful in both [creating](/data-analysis/production/analysis/create-analysis) and [consuming](/data-analysis/production/analysis/consume-analysis) Prophecy applications. To use parameters in a Prophecy App, add an input field and select the parameter for **Configuration field**.
