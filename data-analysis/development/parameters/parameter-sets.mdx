...
When you [schedule a Prophecy App](/data-analysis/production/analysis/consume-analysis), you can choose which pipeline parameter set to use for that schedule. This lets you run the same app with different configurations on different schedules.
