...
A pipeline contains a connected sequence of gems that compile to warehouse-native SQL.  See [Data analysis gems](/data-analysis/gems/gems) for more information on gems.
