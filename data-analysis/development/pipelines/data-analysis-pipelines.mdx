...
You can also create a pipeline from the [project browser](/data-analysis/development/studio/studio#project-browser) by clicking **+** to the right of **Pipelines**.
...
To open a pipeline, click its name in the project browser.
