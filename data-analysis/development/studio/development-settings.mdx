...
Development settings control how Prophecy processes your project during development. Access these settings from the Studio header by clicking the ellipses menu (`...`) and selecting **Development Settings**.
