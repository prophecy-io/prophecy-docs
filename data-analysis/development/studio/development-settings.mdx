...
You can reverse this layout by clicking **Use Original Project Browser Layout**.
...
To view the dbt models created in the backend for pipelines in SQL projects, click **Show Models**.
