...
Development settings control how Prophecy processes your project during development. Access these settings from the Studio header by clicking the arrow to the right of your project's name and selecting **Development Settings**.
...
When you open a project, the Chat panel appears on the left and the Project Browser panel appears on the right.
