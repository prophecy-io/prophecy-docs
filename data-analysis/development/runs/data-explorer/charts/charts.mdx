---
title: Charts
description: View charts of data samples between gems
---
...
![VisualizationView](/data-analysis/development/runs/data-explorer/charts/img/visualization-view.png)
...
![FilterChart](/data-analysis/development/runs/data-explorer/charts/img/filter-chart.png)
...
Only charts based on the output of a Table gem can be added to Prophecy Apps. This is because the [Chart component](/data-analysis/collaboration/prophecy-apps/app-components#charts) in an app must be built on a table as its data source.

![AddChartToApp](/data-analysis/development/runs/data-explorer/charts/img/add-chart-to-app.png)
...
1. Prophecy opens the app inside the [App Builder](/data-analysis/collaboration/prophecy-apps/app-builder). The chart element is added to the bottom of the app.

When someone creates a new app config, they will see the chart as part of the app.

![ViewChartInApp](/data-analysis/development/runs/data-explorer/charts/img/view-chart-in-app.png)

To learn more, see [Prophecy Apps](/data-analysis/collaboration/prophecy-apps/apps).
