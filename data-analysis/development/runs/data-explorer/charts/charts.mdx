...
Only charts based on the output of a Table gem can be added to Prophecy Apps. This is because the [Chart component](/data-analysis/production/analysis/analysis-components#charts) in an app must be built on a table as its data source.
...
1. Prophecy opens the app inside the [App Builder](/data-analysis/production/analysis/create-analysis). The chart element is added to the bottom of the app.
...
To learn more, see [Prophecy Apps](/data-analysis/production/analysis/overview).
