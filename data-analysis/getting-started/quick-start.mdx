...
{/* TODO: Confirm the first-open behavior for quickstart users if AI is disabled. */}
...
{/* TODO: Confirm whether users can create the pipeline from maximized chat or must minimize chat first. */}
...
{/* TODO: Review this video for updated Agent chat and canvas behavior. */}
