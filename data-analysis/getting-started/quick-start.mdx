...
Prophecy will open the your new project in the [Studio](/data-analysis/development/studio/studio). Your project will automatically attach to a fabric in the top right corner of the canvas.
...
The Agent adds a [Table gem](/data-analysis/gems/source-target/source-target) to your pipeline canvas.
...
<Note>
  ...
  gem](/data-analysis/gems/gems#gem-instance) to have a more descriptive name.
</Note>
