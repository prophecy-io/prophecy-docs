...
| **Run Type**   | How the run was triggered. <br />This includes by interactive runs, pipeline schedules, APIs, and analysis runs. <br />Any scheduled runs will include additional information about the schedule that triggered the run. |
