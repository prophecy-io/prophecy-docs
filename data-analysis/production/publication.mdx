...
Next, the project is deployed to different environments. The deployment process builds the project in each target environment ([fabric](/data-analysis/environment/fabrics/prophecy-fabrics)) and enables pipeline [schedules](/data-analysis/production/scheduling/scheduling) for each fabric.
