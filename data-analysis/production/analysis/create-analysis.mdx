...
- Hover the pipeline in the project browser and select the **Create analysis** icon.
- Click the **+** plus icon in the canvas header and select **Create analysis**.

<Frame>![Create analysis icon](/data-analysis/production/analysis/img/add-analysis.png)</Frame>
...
1. For the filter condition:
   ...
   <Frame>
     ...
     parameter](/data-analysis/production/analysis/img/filter-region.png)
   </Frame>
...
<Warning>
  When the analysis runs, Prophecy always executes the entire underlying pipeline. This means any
