...
- Update the analysis dashboard to include [interactive components](/data-analysis/analysis/analysis-components).
...
- Create a new [analysis](/data-analysis/analysis/overview) that links to the pipeline.
- Includes the bar chart which uses input data from the Visualize gem.

![Send Agent prompt](/data-analysis/analysis/img/prompt-analysis.png)
...
<Frame>![Create analysis icon](/data-analysis/analysis/img/add-analysis.png)</Frame>
