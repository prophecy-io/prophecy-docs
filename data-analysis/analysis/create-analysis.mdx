...
| Field            | Description                                                                 |
|------------------|-----------------------------------------------------------------------------|
| **Analysis name** | Use alphanumeric characters and underscores.                               |
| **Description**   | Optional description of the analysis.                                      |
| **Pipeline name** | Select the pipeline to associate with the analysis.                        |
| **Parameter set** | Choose which parameter set to use.                                         |
| **Directory path**| Leave the default or select a different location.                          |
