...
- Configurations that store reusable runtime values
...
- **Edit mode** — Build and configure the analysis layout and components
- **Preview mode** — Run the analysis as an end user would experience it

In edit mode, you add components, configure charts, and bind inputs to parameters.

In preview mode, you enter runtime values, execute the pipeline, and review results.
