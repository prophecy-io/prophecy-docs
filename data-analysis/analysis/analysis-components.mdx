...
Interactive components enable users to assign values to [pipeline parameters](/data-analysis/development/pipeline-params). These values can influence the behavior of each pipeline run and change the output that appears in the analysis.
