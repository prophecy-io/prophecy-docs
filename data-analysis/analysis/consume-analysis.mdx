...
Configurations appear under the analysis in the App Browser. Each analysis can contain multiple configurations, which you can select, rename, schedule, or run independently.

Runtime values entered in a configuration override the pipeline's default parameter values during execution.

## Create a configuration

1. In the **App Browser**, hover over an analysis.
2. Click the **+** icon.
...
You can switch between configurations by selecting them in the App Browser.
