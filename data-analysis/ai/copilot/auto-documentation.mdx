...
![Generate source and target descriptions](/data-analysis/ai/copilot/img/copilot-source-target.png)
...
![Generate gem label](/data-analysis/ai/copilot/img/gem-label.png)
