...
![Copilot inline fix](/data-analysis/ai/copilot/img/copilot-expression-fix.gif)
...
![Copilot fix on save](/data-analysis/ai/copilot/img/copilot-fix-diagnostics.png)

## Gem-level fix

On the pipeline canvas, open a gem's action menu and select **Fix** to automatically correct errors within that component.

![Copilot fix gem](/data-analysis/ai/copilot/img/copilot-fix-gem.png)
