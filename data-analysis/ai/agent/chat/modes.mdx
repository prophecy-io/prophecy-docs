...
{/* TODO: Confirm whether this toggle remains in the chat body/header after the chat header update. */}

<Frame>
  <WistiaVideo mediaId="x8e0n7shbo" />
</Frame>
{/* TODO: Review this video for updated Agent chat header controls. */}
