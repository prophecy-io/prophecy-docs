...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| Select or create connection | Defines which [SMTP connection](/data-analysis/environment/connections/smtp) to use for the gem. <br/>This will also determine the **sender** of the email.                            | Not applicable      |
