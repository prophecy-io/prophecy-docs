...
The Visualize gem doesn't perform any data transformations. Instead, it marks a point in your pipeline where you want to capture data to display in an [analysis dashboard](/data-analysis/production/analysis/overview). This gem lets you report data outcomes without having to materialize the data in your data warehouse or another data storage location.
