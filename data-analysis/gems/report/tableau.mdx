...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Select or create connection | Defines which [Tableau connection](/data-analysis/environment/connections/tableau) to use for the gem.                                       |
...
![Tableau Gem configuration](/data-analysis/gems/report/img/tableau-gem.png)
