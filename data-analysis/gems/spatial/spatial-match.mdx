...
- [CreatePoint](/data-analysis/gems/spatial/create-point) gem for points
- [PolyBuild](/data-analysis/gems/spatial/polybuild) gem for lines and polygons
...
![Match types diagram](/data-analysis/gems/spatial/img/match-types.jpg)
