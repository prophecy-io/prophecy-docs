...
| Parameter | Description |
| --------- | ----------- |
| Select tiling options | Configure the **Equal Sum** method. |
...
| Parameter | Description |
| --------- | ----------- |
| Select tiling options | Configure the **Equal Records** method. |
| Number of Tiles | Specify how many tiles to assign. |
| Select group by columns (Optional) | Optionally select fields to create tiles independently within each group. |
...
| Parameter | Description |
| --------- | ----------- |
| Select tiling options | Configure the **Smart Tile** method. |
