---
title: FlattenSchema gem for Data Analysis
...
<GemExample gemName="FlattenSchema" />

## Variant data

When you import tables with variant data into Prophecy, you'll see one or more nested columns in your dataset schema. These will appear as a [variant data type](/data-analysis/gems/visual-expression-builder/variant-schema), which is an array of values with more than one data type. Variant types can be flattened. This data type is specific to Databricks and Snowflake.
...
1. In the **Input** tab, hover over the `in0` field and click the **Add 12 Columns** button.
   ...
   ![Adding expressions](/data-analysis/gems/prepare/img/flatten_add_exp.png)
...
![Output interim](/data-analysis/gems/prepare/img/flatten_output_interim.png)
