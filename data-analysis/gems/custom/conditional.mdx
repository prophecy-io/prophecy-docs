...
Both the [Filter gem](/data-analysis/gems/prepare/filter) and the Conditional gem evaluate conditions on a dataset, but they serve different purposes.
...
Use the Conditional gem when you want to route rows to different paths based on conditions.
