...
1. Open a gem that uses a variant column input, such as the [FlattenSchema gem](/data-analysis/gems/prepare/flatten-schema).
...
1. Click the **Variant** dropdown, and click **Infer Schema**.
   ...
   ![Schema and column selector](/data-analysis/gems/visual-expression-builder/img/variant-infer-schema.png)
...
1. Use the data type dropdowns to manually choose the data type of each nested schema.
   ...
   ![Edit schema view](/data-analysis/gems/visual-expression-builder/img/variant-edit-schema.png)
...
1. Put in the number of records you want Prophecy to parse to understand the nested data schema.
   ...
   ![Variant sampling setting](/data-analysis/gems/visual-expression-builder/img/variant-sampling-setting.png)

<Note>
  This setting does not rely on the ratio of the data since that would require a complete count of
  the data records.
</Note>
...
![Add column](/data-analysis/gems/visual-expression-builder/img/variant-add-column.png)
