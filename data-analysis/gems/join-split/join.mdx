...
- **Semi Join** to keep rows from the first dataset that have a match in the second, without adding any of its columns.
- **Anti Join** to keep rows from the first dataset that have *no* match in the second.
