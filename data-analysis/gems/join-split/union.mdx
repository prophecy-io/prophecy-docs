...
All input tables must have **identical schemas** (matching column names and data types). If table columns have different orders or a different number of columns, use the [UnionByName](/data-analysis/gems/join-split/union-by-name) gem.
