...
![Generate source and target descriptions](/data-analysis/gems/copilot/img/copilot-source-target.png)
...
<Frame>
  <WistiaVideo mediaId="vdwma81pos" />
</Frame>

Find the **Explain** option in the gem action menu. To learn more, visit the documentation on [gems](/data-analysis/gems/gems).
...
![Generate gem label](/data-analysis/gems/copilot/img/gem-label.png)
...
Find the **Label** and **Add Comment** options in the gem action menu. To learn more, visit the documentation on [gems](/data-analysis/gems/gems).
