---
title: MSSQL external table gem
...
| Select or create connection | Select or create a new [MSSQL connection](/data-analysis/environment/connections/mssql) in the Prophecy fabric you will use. |
