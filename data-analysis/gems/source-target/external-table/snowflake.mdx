---
title: Snowflake external table gem
...
| Select or create connection | Choose or create a [Snowflake connection](/data-analysis/environment/connections/snowflake) in the Prophecy fabric you will use. |
