---
title: Databricks external table gem
...
This page describes how to use Databricks external Source and Target gems to read from or write to tables. Only use an external Source and Target gem when Databricks is not the configured [SQL warehouse connection](/data-analysis/environment/fabrics/prophecy-fabrics). Otherwise, use the Table gem to [read from](/data-analysis/gems/source-target/table/bigquery-read) and [write to](/data-analysis/gems/source-target/table/bigquery-write) Databricks.
