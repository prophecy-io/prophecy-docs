---
title: MongoDB external table gem
...
| Select or create connection | Select or create a new [MongoDB connection](/data-analysis/environment/connections/mongodb) in the Prophecy fabric you will use. |
