...
When you choose the **Append Rows** option, Prophecy adds new rows to the existing table without modifying existing data. No deduplication is performed, so you may end up with duplicate records.
