...
This page explains how to write to a Snowflake table or view using the Table gem. To read from an existing Snowflake table or view instead, see [Read from Snowflake tables](/data-analysis/gems/source-target/table/snowflake-write)
