...
| Write Options | Select how you want the data to be written each time you run the pipeline (Table only). Learn more in [Write Options](/data-analysis/gems/source-target/table/write-options). |
