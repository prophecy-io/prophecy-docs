---
title: Databricks table gem
description: Read from Databricks tables
---
...
Here, you can create and run [data tests](/data-analysis/development/tests/table-tests) for the table. Table tests are reusable SQL queries that validate your data quality.
