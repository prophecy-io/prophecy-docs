...
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Select or create connection                          | Select an existing S3 connection or [create a new one](/data-analysis/environment/connections/s3).                                                                                                                                                           |
...
| File Path<br/>_Filepath option only_                 | Path to the file in the S3 bucket. Supports wildcards. <br/>Example: `/temp/dir/*.csv`                                                                                                                                                                       |
...
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Select or create connection | Select an existing S3 connection or [create a new one](/data-analysis/environment/connections/s3).                                            |
| File Path                   | S3 path where the output file will be written. <br/>Example: `s3://my-bucket/data/orders.csv`                                                 |
