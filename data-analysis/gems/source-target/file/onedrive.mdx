---
title: Microsoft OneDrive file gem
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Select or create connection | Select an existing OneDrive connection or [create a new one](/data-analysis/environment/connections/onedrive).                        |
| File Path                   | Path to the file in OneDrive.                                                                                                         |
