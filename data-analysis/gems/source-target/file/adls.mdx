...
| File Path<br/>_Filepath option only_                 | Path to the file in the ADLS container. Supports wildcards. <br/>Example: `abfss://container-name@account-name.dfs.core.windows.net/temp/dir/*.csv`                                                                                                          |
