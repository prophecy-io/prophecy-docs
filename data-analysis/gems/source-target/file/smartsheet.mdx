...
<Step title="Set file properties">
  ...
  [Excel](/data-analysis/gems/source-target/file/file-types/excel) to view XLSX-specific properties.
</Step>
...
| File Path                   | Path to the file in Smartsheet. <br/>Example: `/Projects/ProjectName/file.csv`                                                        |
