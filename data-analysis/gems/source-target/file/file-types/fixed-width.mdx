...
<Info>Writing fixed-width files using a Target gem is not supported.</Info>
...
<Note>
  For a complete list of supported data types, visit [Supported data
  types](/data-analysis/gems/data-types).
</Note>

## Source properties

The following properties are available to customize how fixed-width files are read.
