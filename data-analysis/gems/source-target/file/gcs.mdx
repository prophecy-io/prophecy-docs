...
| File Path<br/>_Filepath option only_                 | Path to the file in the GCS bucket. Supports wildcards. <br />Example: `gs://my-bucket/temp/dir/*.csv`                                                                                                                                                       |
...
| Move files after successfully processed              | Moves objects to a specified directory after they are successfully read. <br /><br />Example: `gs://my-bucket/archive/`                                                                                                                                      |
...
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Select or create connection | Select an existing GCS connection or [create a new one](/data-analysis/environment/connections/gcs).                                          |
| File Path                   | GCS path where the output file will be written. <br/>Example: `gs://my-bucket/data/orders.csv`                                                |
