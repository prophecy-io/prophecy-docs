---
title: WindowFunction gem for Data Analysis
...
<GemExample gemName="WindowFunction" />
...
<Note>This gem only supports a single input and output port.</Note>
...
<Note>You must define an Order By column to use a [range frame](#range-frame) window frame.</Note>
...
<Info>
  For a full list of available functions, visit the [Window
  functions](https://docs.databricks.com/aws/en/sql/language-manual/sql-ref-window-functions#parameters)
  page of the Databricks documentation.
</Info>
