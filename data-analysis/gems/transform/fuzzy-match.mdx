---
title: FuzzyMatch gem for Data Analysis
...
<Info>
  Depending on your SQL provider, you might see different similarity scores based on the algorithm
  that runs under the hood.
</Info>

<Tip>
  To view the names per record, [join](/data-analysis/gems/join-split/join) the FuzzyMatch output
