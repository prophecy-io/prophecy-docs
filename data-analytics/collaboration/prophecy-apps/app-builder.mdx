...
![App Builder](/data-analytics/collaboration/prophecy-apps/img/app-builder.png)
...
- Follow the tutorial to [Create a Prophecy App](/data-analytics/collaboration/prophecy-apps/app-creation).
- Review the full [list of components](/data-analytics/collaboration/prophecy-apps/app-components) you can leverage in an app.
