...
![Prophecy Config UI](/data-analytics/collaboration/prophecy-apps/img/prophecy-app-ui.png)
...
After you create the schedule, publish it to the appropriate fabric (the execution environment that the pipeline will run on). This is the same process as [scheduling pipelines](/data-analytics/production/scheduling/scheduling) themselves.
...
<Info>
  ...
  access](/data-analytics/administration/management/users/access/team-based-access).
</Info>
...
- [Create a Prophecy App](/data-analytics/collaboration/prophecy-apps/app-creation)
- [Define pipeline parameters](/data-analytics/development/pipeline-params)
- [Publish a project](/data-analytics/production/publication)
