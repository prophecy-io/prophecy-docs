...
<Callout icon="/images/icon.png" color="#FFC107">
  Replays are available in [Free and Professional Editions](/data-engineering/administration/platform/editions) only.
</Callout>
...
<Tip>
  To learn more about commit history, visit [Versioning](/data-analytics/development/versioning/version-control).
</Tip>
