...
<Callout icon="/images/icon.png" color="#FFC107">
  ...
  Editions](/data-analytics/administration/platform/editions) only.
</Callout>
...
When viewers click **Exit** on a replay, they enter **View** mode, which is the same read-only interface used for [public sharing](/data-analytics/collaboration/project-sharing). In View mode, they can explore the completed pipeline but cannot make changes.
