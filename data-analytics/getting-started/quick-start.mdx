...
To complete this quick start, you need a [Prophecy fabric](/data-analytics/environment/fabrics/prophecy-fabrics) that uses Prophecy In Memory or Databricks as the compute engine.
...
First, you need to create the project where you will build your pipeline. You'll also need to add data to the project for this quick start.
...
<Note>
The AI agent will infer join keys, but you can also specify them explicitly.
</Note>
</Step>
...
<Accordion title="Leverage both the AI agent and visual interface">
