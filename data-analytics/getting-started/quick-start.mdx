...
Prophecy should automatically index the table when you save the seed. This allows the Agent to discover and use the seed data. If you have trouble finding the table in later steps, you can also manually reindex the [knowledge graph](/data-analytics/ai/knowledge-graph/knowledge-graph).
...
<Note>
  ...
  history](/data-analytics/development/versioning/version-control#show-version-history). You can
...
**Probable cause**: [Knowledge graph](/data-analytics/ai/knowledge-graph/knowledge-graph) is out of date
