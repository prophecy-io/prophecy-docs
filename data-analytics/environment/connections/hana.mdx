...
| Feature                                                                    | Supported |
| -------------------------------------------------------------------------- | --------- |
| Read data with a [Source gem](/data-analytics/gems/source-target/external-table/hana/hana)                          | Yes       |
| Write data with a [Target gem](/data-analytics/gems/source-target/external-table/hana/hana)                         | Yes       |
...
Connections in Prophecy are stored within [fabrics](/data-analytics/environment/fabrics/prophecy-fabrics), which are assigned to specific teams. Once a Hana connection is added to a fabric, all team members who have access to the fabric can use the connection in their projects. No additional authentication is required—team members automatically inherit the access and permissions of the stored connection credentials.
