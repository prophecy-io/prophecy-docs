---
title: ProphecyManaged
description: Learn about the default ProphecyManaged fabric
---

<Callout icon="/images/icon.png" color="#FFC107">
  Available for [Free and Professional Editions](/data-engineering/administration/platform/editions) only.
</Callout>

When you first sign in to Prophecy (Free or Professional Edition), you get access to automatically-provisioned [Prophecy fabrics](/data-analytics/environment/fabrics/prophecy-fabrics). Each fabric includes a default SQL warehouse connection called **ProphecyManaged**. This connects you to [Prophecy In Memory](/data-analytics/environment/fabrics/prophecy-fabrics).
