...
| Feature                                                                    | Supported |
| -------------------------------------------------------------------------- | --------- |
| Read data with a [Source gem](/data-analytics/gems/source-target/external-table/snowflake)                         | Yes       |
| Write data with a [Target gem](/data-analytics/gems/source-target/external-table/snowflake)                        | Yes       |
...
| Authentication method | Enter your Snowflake username and use a [secret](/data-analytics/environment/secrets/secrets) to enter your password.      |
...
Connections in Prophecy are stored within [fabrics](/data-analytics/environment/fabrics/prophecy-fabrics), which are assigned to specific teams. Once a Snowflake connection is added to a fabric, all team members who have access to the fabric can use the connection in their projects. No additional authentication is required—team members automatically inherit the access and permissions of the stored connection credentials.
