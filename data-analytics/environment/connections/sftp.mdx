---
title: SFTP
description: Learn how to set up SFTP in Prophecy
---
...
| Feature                                                                                                     | Supported |
| ----------------------------------------------------------------------------------------------------------- | --------- |
| Read data with a [Source gem](/data-analytics/gems/source-target/file/sftp)                                                           | Yes       |
| Write data with a [Target gem](/data-analytics/gems/source-target/file/sftp)                                                          | Yes       |
...
- **Password:** Use a [secret](/data-analytics/environment/secrets/secrets) to enter your SFTP password.
