...
<Info>
  ...
  execution](/analysts/pipeline-execution#external-data-handling). Therefore, you must have write
...
<Info>Learn more in [Supported data types](/analysts/data-types).</Info>
