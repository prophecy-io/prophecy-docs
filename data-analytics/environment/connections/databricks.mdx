...
<Info>
  ...
  execution](/data-analytics/development/runs/execution#external-data-handling). Therefore, you must have write
  access to the schema in Databricks. To avoid conflicts, define distinct catalog and schema
  locations for each fabric.
</Info>
...
| --------------------------- | ----------------------------- | --------------------------------------------------------------- | ----------------------------------- | -------------------------- |
| **User-based (U2M)**        | Individual user accounts      | [App Registration](/data-engineering/administration/management/cluster-admin-settings/oauth-setup)                                | Periodic re-authentication required | Interactive development    |
