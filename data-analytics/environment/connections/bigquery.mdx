...
If no app registrations appear, an admin must configure an [OAuth app registration](/data-engineering/administration/management/cluster-admin-settings/oauth-setup).
...
<Info>
Learn more in [Supported data types](/data-analytics/gems/data-types).
</Info>
