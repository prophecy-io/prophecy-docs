...
- [Smartsheet](/data-analytics/gems/source-target/file/smartsheet)

<Info>
  You can also use the [upload
  file](docs/analysts/development/gems/source-target/table/upload-files.md) feature to use Excel
...
<Info>The union operation will only succeed if each sheet has the same schema.</Info>
