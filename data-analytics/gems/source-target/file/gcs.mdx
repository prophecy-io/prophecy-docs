...
1. Set up your [GCS connection](/data-analytics/environment/connections/gcs).
...
| Select or create connection                          | Select an existing GCS connection or [create a new one](/data-analytics/environment/connections/gcs).                                                                                                                |
