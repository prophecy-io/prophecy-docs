...
<Step title="Select S3 format">In the **Type** tab, select **S3**. Then, click **Next**.</Step>
...
| Select or create connection                          | Select an existing S3 connection or [create a new one](/data-analytics/environment/connections/s3).                                                                                                                                                           |
