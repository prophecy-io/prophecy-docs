...
1. Set up your [ADLS connection](/administration/fabrics/prophecy-fabrics/connections/adls).
...
| Select or create connection                          | Select an existing ADLS connection or [create a new one](/administration/fabrics/prophecy-fabrics/connections/adls).                                                                                                              |
