...
1. Set up your [ADLS connection](/data-analytics/environment/connections/adls).

2. Add a new Source or Target gem to your pipeline canvas and open the configuration.

3. In the **Type** tab, select **ADLS**.

4. In the **Location** tab, choose your [file format](#supported-file-formats) and location.
