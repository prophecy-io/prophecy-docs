...
1. Set up your [SFTP connection](/data-analytics/environment/connections/sftp).
...
1. In the **Location** tab, choose your [file format](#supported-file-formats) and location.
   ...
   <Info>
     For more information on how to configure this screen, jump to [Source
     location](#source-location) and [Target location](#target-location).
   </Info>
