...
When you upload your file through Prophecy, it's added directly to your SQL warehouse as a [table](/data-analytics/gems/source-target/source-target).
...
![Upload file by dragging and dropping](/data-analytics/gems/source-target/table/img/upload-file-drag-drop.png)
...
![Select your file type and format](/data-analytics/gems/source-target/table/img/upload-file-type-format.png)
...
![Select the table location](/data-analytics/gems/source-target/table/img/upload-file-location.png)
...
![Configure the table properties](/data-analytics/gems/source-target/table/img/upload-file-properties.png)
...
![Preview the table](/data-analytics/gems/source-target/table/img/upload-file-preview.png)
