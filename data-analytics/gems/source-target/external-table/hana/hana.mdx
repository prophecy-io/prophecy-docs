...
- **Type**: Select the SAP HANA table option.
- **Source/Target location**: Choose the [connection](/data-analytics/environment/connections/hana) and define the location where you will read/write tables in SAP HANA.
