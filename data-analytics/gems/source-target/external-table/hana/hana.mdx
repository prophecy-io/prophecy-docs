...
| Select or create connection | Select or create a new [SAP HANA connection](/data-analytics/environment/connections/hana) in the Prophecy fabric you will use.                         |
...
Generated columns are specific to SAP HANA and auto-generate values for new rows. You can define generated columns in the Properties tab via column-level metadata. Learn more in [Generated columns](/data-analytics/gems/source-target/external-table/hana/identity-columns).
