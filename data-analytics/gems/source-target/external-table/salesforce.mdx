...
| Select or create connection | Select or create a new [Salesforce connection](/data-analytics/environment/connections/salesforce) in the Prophecy fabric you will use. |
