...
![Infer schema](/data-analytics/gems/img/data-types.png)

## Data types

The tables below list the data types Prophecy supports depending on the [SQL warehouse](/data-analytics/environment/fabrics/prophecy-fabrics) you use for processing.
