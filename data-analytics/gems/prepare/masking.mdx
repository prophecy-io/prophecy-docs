...
import MySnippet from '/snippets/gem-execution-engine.mdx';

<MySnippet execution_engine="SQL warehouse" />
...
- Add the ProphecyDatabricksSqlBasics 0.0.12+ package to your project.
