...
<Info>
  ...
  ports](/data-analytics/gems/gems#gem-ports).
</Info>
...
- **Basic Auth**: Automatically sends Base64-encoded username and password from a [Username & Password secret](/data-analytics/environment/secrets/secrets).
- **Bearer Token**: Automatically sends a bearer token retrieved through OAuth. Prophecy uses a preconfigured [M2M OAuth secret](/data-analytics/environment/secrets/secrets) to obtain this token on your behalf.
