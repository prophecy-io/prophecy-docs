---
title: Script
description: Embed a custom Python script in your pipeline
---

import MySnippet from '/snippets/interactive-gem.mdx';

<MySnippet gemName="Script" />

## Where the script runs

The execution environment for the Script gem depends on the [SQL warehouse](/data-analytics/environment/fabrics/prophecy-fabrics) configured in your Prophecy fabric.
...
When using a fabric with [service principal authentication for Databricks](/data-analytics/environment/connections/databricks), you may encounter the following error:
