...
| Table Connection Type       | Select the type of [data ingress/egress connection](/data-analytics/environment/connections/connections) to use. |
...
1. Select an existing connection or [create a new one](/data-analytics/environment/connections/oracle).
...
| File Connection Type        | Select the file storage [connection](/data-analytics/environment/connections/connections) type to use.                                                                                                                                                                                                                        |
