...
<Info>
  ...
  tab. To learn more about adding and removing ports, see [Gem ports](/data-analytics/gems/gems#gem-ports).
</Info>
...
<Note>
  ...
  In Memory](/data-analytics/environment/fabrics/prophecy-fabrics), use DuckDB dialect.
</Note>
