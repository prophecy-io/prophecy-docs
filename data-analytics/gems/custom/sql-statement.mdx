...
<MySnippet gemName="SQLStatement" />
...
<Info>
  ...
  tab. To learn more about adding and removing ports, see [Gem ports](/analysts/gems#gem-ports).
</Info>
...
<Note>
  ...
  In Memory](docs/administration/fabrics/prophecy-fabrics/prophecy-fabrics.md), use DuckDB dialect.
</Note>

<Tip>
  To reference the input table in the SQL query, use the name of the gem that generates the input
  table.
</Tip>
