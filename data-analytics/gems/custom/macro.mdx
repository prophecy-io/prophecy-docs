...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Macro         | The macro that you wish to use.<br/>Note: You can only select a Gem macro. You cannot select a macro defined as a [function](/data-analytics/development/extensibility/functions). |
...
For this example, assume you want to use the `dbt_utils` package as a [dependency](/data-analytics/development/extensibility/dependencies) in your project.
...
![Unpivot macro](/data-analytics/gems/custom/img/unpivot-macro.png)
