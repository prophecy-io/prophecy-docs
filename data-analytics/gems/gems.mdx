...
Gems are functional units in a [pipeline](/data-analytics/development/pipelines/pipelines) that perform tasks such as reading, transforming, writing, or handling other data operations. When you build pipelines in a SQL project, some gems will be powered by [Prophecy Automate](/data-analytics/environment/fabrics/prophecy-fabrics.mdx), and some gems will be powered by SQL dbt.
