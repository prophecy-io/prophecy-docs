...
- Add the `ProphecyDatabricksSqlSpatial` package version 0.0.3 or higher to your project.
...
<Tip>
  ...
  [CreatePoint](/analysts/create-point) gem to convert longitude and latitude coordinates to WKT
  format.
</Tip>
