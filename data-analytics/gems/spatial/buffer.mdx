...
<Info>This gem runs in the SQL warehouse.</Info>
...
- Add the ProphecyDatabricksSqlSpatial 0.0.3+ package to your project.
...
<Tip>
Input geometries must be in Well-known Text ([WKT](https://en.wikipedia.org/wiki/Well-known_text_representation_of_geometry)) geometric format. Use the [PolyBuild](/analysts/polybuild) gem to create lines and polygons in this format from latitude and longitude coordinates.
</Tip>
