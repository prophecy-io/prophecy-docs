...
- Add the `ProphecyDatabricksSqlSpatial` package version 0.0.4 or higher to your project.
...
<Tip>
  ...
  [PolyBuild](/analysts/polybuild) gem to convert longitude and latitude coordinates into polygons
  or polylines in WKT format.
</Tip>
