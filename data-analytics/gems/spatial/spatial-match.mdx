...
<MySnippet gemName="SpatialMatch" />
...
- [CreatePoint](/data-analytics/gems/spatial/create-point) gem for points
- [PolyBuild](/data-analytics/gems/spatial/polybuild) gem for lines and polygons
...
![Match types diagram](/data-analytics/gems/spatial/img/match-types.jpg)
