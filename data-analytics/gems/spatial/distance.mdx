...
<Note>
  ...
  [CreatePoint](/data-analytics/gems/spatial/create-point) gem to convert longitude and latitude coordinates to WKT
  format.
</Note>
...
1. Set source and destination:
   ...
   1. Set **Source Column** to `start`.

   1. Set **Destination Type** to **Point**.

   1. Set **Destination Column** to `destination`.
