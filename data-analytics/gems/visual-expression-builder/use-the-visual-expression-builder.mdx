...
In addition to using the [expression options](/data-analytics/gems/visual-expression-builder/visual-expression-builder-reference) that appear when you open the visual expression builder, you can also create additional configurations that add complexity to your expressions. This page explains the advanced expressions that you can achieve with the visual expression builder.
...
| Parameters | Enables you to include variables in your expressions that may vary at runtime. Parameters only show up in the **Configuration Variables** of the visual expression builder after you have [created them](/data-analytics/development/pipeline-params) at the pipeline level. |
...
![Reformat gem using Comparison mode](/data-analytics/gems/visual-expression-builder/img/reformat-visual-expression-builder.png)
...
![Filter gem using Grouping mode](/data-analytics/gems/visual-expression-builder/img/filter-visual-expression-builder.png)
...
![Create string array](/data-analytics/gems/visual-expression-builder/img/array-param.png)
...
![Filter using array](/data-analytics/gems/visual-expression-builder/img/filter-array.png)
