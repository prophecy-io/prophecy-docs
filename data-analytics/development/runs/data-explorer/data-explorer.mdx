...
- [Run](/data-analytics/development/runs/execution) the relevant pipeline in the project editor.
...
![Data sample in a pipeline](/data-analytics/development/runs/data-explorer/img/data-sample-analysts.png)
...
- View your data as a chart in the [Visualization](/data-analytics/development/runs/data-explorer/charts/charts) tab

![DataExplorationSQL](/data-analytics/development/runs/data-explorer/img/DataExplorationSQL.png)
