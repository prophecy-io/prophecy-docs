...
Data profiling allows you to view statistics on interim datasets in your pipeline. When you open a dataset's profile in the [Data Explorer](/data-analytics/development/runs/data-explorer/data-explorer), you can visualize value distributions and data completeness to ensure your data matches expectations.
...
![Quick profile](/data-analytics/development/runs/data-explorer/img/quick-data-profile.png)
...
![Expanded profile](/data-analytics/development/runs/data-explorer/img/expanded-profile.png)
...
![Show Expanded Profile](/data-analytics/development/runs/data-explorer/img/open-expanded-profile.png)
