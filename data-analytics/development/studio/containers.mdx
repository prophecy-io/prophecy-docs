...
![Pipeline grouped into two visual containers](/data-analytics/development/studio/img/grouped-pipeline.png)
...
![Pipeline with collapsed container](/data-analytics/development/studio/img/collapsed-groups.png)
