...
- Configuring pipelines for multiple execution environments (such as development or production). Use app configs or the [Deploy Project API](/api-reference/project-deployment/deploy-project) to do so.
