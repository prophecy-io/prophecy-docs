...
The Advanced settings are generally equivalent to the [Data Test gem parameters](/data-analytics/development/tests/project-tests#data-test-gem-parameters).
