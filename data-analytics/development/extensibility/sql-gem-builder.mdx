...
<Callout icon="/images/icon.png" color="#FFC107">
  Available for [Enterprise Edition](/data-analytics/administration/platform/editions) only.
</Callout>

[Gems](/data-analytics/gems/gems) handle individual data processing tasks in a pipeline or model. While Prophecy offers dozens of gems out-of-the-box, you might want to create your own gems.
...
![Gem builder new gem](/data-analytics/development/extensibility/img/gem-builder-new.png)
...
![Gem builder create SQL query](/data-analytics/development/extensibility/img/gem-builder-sql-query.png)
...
![Gem builder customize interface](/data-analytics/development/extensibility/img/gem-builder-interface.png)
...
![Gem builder preview](/data-analytics/development/extensibility/img/gem-builder-preview.png)
