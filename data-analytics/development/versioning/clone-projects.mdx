...
Unlike [importing](/data-analytics/development/versioning/import-projects), which connects to an existing repository, cloning creates a fresh repository for the new project.
...
1. Configure the clone settings:
   ...
   - **Git Storage Model**: Choose between Simple or Normal [Git model](/data-analytics/development/versioning/version-control#version-control-options)
