...
<Info>
  All projects that utilize the **Prophecy for Analysts** [project creation
  template](/data-analytics/administration/management/administration/platform/project-creation-template)
  operate with Simple, Prophecy-managed Git.
</Info>

## Simple/Prophecy-managed

When you create a project that uses [Simple](/data-analytics/development/versioning/version-control) Git, Prophecy restricts pipeline editing to a single user at a time.
