...
sidebarTitle: 'Migrate to external Git'
...
- The original project must be a SQL project that uses the [Simple Git Storage Model](/data-analytics/development/versioning/version-control#version-control-options).
...
- You must have valid credentials for the external Git provider. If you don't, team members can [share credentials](/data-engineering/ci-cd/git/git#share-credentials) with you in Prophecy.
