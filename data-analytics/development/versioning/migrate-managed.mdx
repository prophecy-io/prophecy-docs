...
- The original project must be a SQL project that uses the [Simple Git Storage Model](/data-analytics/versioning/#version-control-options).
...
- You must have valid credentials for the external Git provider. If you don't, team members can [share credentials](/data-engineering/git/#share-credentials) with you in Prophecy.
