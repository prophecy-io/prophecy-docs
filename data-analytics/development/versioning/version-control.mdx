...
<Note>
  The way you use Git will also influence how you collaborate in Prophecy. To learn more, visit [Real-time collaboration](/data-analytics/development/versioning/collaboration-modes).
</Note>
...
- [Package Hub](/data-engineering/extensibility/package-hub/package-hub) packages
