...
The following sections demonstrate the **visual workflow** for projects that use the Simple Git Storage Model. To view the workflow for normal Git, visit the section on [Git](/data-engineering/ci-cd/git/git) in the documentation.

<Note>
  The way you use Git will also influence how you collaborate in Prophecy. To learn more, visit
  [Real-time collaboration](/data-analytics/development/versioning/collaboration-modes).
</Note>
...
- [Scheduled pipeline runs](/data-analytics/production/scheduling/scheduling) (depending on the fabric)
- [Package Hub](/data-analytics/development/extensibility/package-hub/package-hub) packages
- [App Browser](/data-analytics/collaboration/prophecy-apps/apps) applications

To learn more, visit our page on [project publication](/data-analytics/production/publication).
