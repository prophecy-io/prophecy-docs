...
You need at least one [Source gem](/data-analytics/gems/source-target/source-target) in your pipeline to add transformation gems with AI chat.
...
![Agent SQL logs](/data-analytics/ai/agent/img/agent-sql-logs.png)
...
All changes made by the Agent are saved in the project [version history](/data-analytics/development/versioning/version-control). Commits will be clearly marked as authored by the Agent.
