---
title: 'Overview'
description: 'How do I use the Agent?'
---
...
1. The Agent will search metadata, retrieve sample data, generate transformations, and optimize existing pipelines.
1. Use the Agent to build pipelines incrementally or generate complete pipelines from a single prompt.
