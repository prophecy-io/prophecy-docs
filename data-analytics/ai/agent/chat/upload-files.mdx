...
After uploading a file, the [knowledge graph indexer](/data-analytics/ai/knowledge-graph/indexer) will automatically index the table. However, you can also manually reindex the knowledge graph, in case something goes wrong.
