...
<Info>
  ...
  settings](/data-engineering/administration/management/cluster-admin-settings/copilot-settings) to learn how to
  connect Prophecy to your LLM.
</Info>

## Supported providers

Prophecy supports model families from the following providers:
...
class DOA,EOA,AOA,DGA,VA,DAA nodeStyle
```
