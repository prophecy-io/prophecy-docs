...
1. Connects to your data storage connections using configured identities.
2. Scans databases and file storage systems that the identities have access to.
...
Prophecy lets you configure authentication credentials for the knowledge graph indexer separately from pipeline execution credentials for the **Databricks SQL warehouse connection**, allowing you to control which tables get indexed and how results are scoped for different users.
