...
<Tip>
  ...
  [agent](/analysts/ai-explore#troubleshooting) can't locate a table during a conversation.
</Tip>
...
<Note>
  ...
  Token](/environment/connections/databricks#personal-access-token-pat) (rather than OAuth). This
...
- Configure your SQL warehouse connection with a [Databricks connection](/environment/connections/databricks). Other SQL warehouses are not supported.
