...
![Generate source and target descriptions](/data-analytics/ai/copilot/img/copilot-source-target.png)

## Understand each gem

When you want to know a specific gem's purpose in the pipeline, you can ask Copilot to explain it in plain language.

![Generate gem explanation](/data-analytics/ai/copilot/img/gem-explain.gif)

Find the **Explain** option in the gem action menu. To learn more, visit the documentation on [gems](/data-analytics/gems/gems).
...
![Generate gem label](/data-analytics/ai/copilot/img/gem-label.png)
...
Find the **Label** and **Add Comment** options in the gem action menu. To learn more, visit the documentation on [gems](/data-analytics/gems/gems).
