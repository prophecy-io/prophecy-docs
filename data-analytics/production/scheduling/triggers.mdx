...
<Info>
  Prophecy supports file change detection (data change sensors) for [S3](/data-analytics/environment/connections/s3) and [SFTP](/data-analytics/environment/connections/sftp) connections only.
</Info>
