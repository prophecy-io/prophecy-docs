...
The **Deployed Projects** tab in the Observability interface shows all projects that have been [published](/data-analytics/development/versioning/version-control) to Prophecy fabrics. It gives you visibility into release versions and recent execution status at the project level.
...
| Column         | Description                                                                                                                                                                                                                             |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**         | Hover the **#** sign to view the full unique pipeline run ID. <br />You can reference this value in the [Trigger Pipeline API](/api-reference/endpoint/trigger-run#get-pipeline-run-status).                                            |
